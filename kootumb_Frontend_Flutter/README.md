<img alt="kootumb logo" src="https://snipboard.io/4XYjuR.jpg" width="300">

kootumb mobile app. (FrontEnd Flutter)
...
* [kootumb-api](https://github.com/KootumbOrg/kootumb-api)
...
It's dependent on the [kootumb-api](https://github.com/KootumbOrg/kootumb-api) backend.
...
Please read and follow our [Code of Conduct](https://github.com/KootumbOrg/kootumb-app/blob/master/CODE_OF_CONDUCT.md).
...
Please read carefully [our license](https://github.com/KootumbOrg/kootumb-app/blob/master/LICENSE.txt) and ask us if you have any questions.

#### Responsible disclosure

Cyber-hero? Check out our [Vulnerability Disclosure page](https://www.kootumb.com/en/vulnerability-report).

#### Other issues

We're available almost 24/7 in the Kootumb slack channel. [Join us!](https://join.slack.com/t/kootumb/shared_invite/enQtNDI2NjI3MDM0MzA2LTYwM2E1Y2NhYWRmNTMzZjFhYWZlYmM2YTQ0MWEwYjYyMzcxMGI0MTFhNTIwYjU2ZDI1YjllYzlhOWZjZDc4ZWY)
...
### 1. Install the `kootumb-api` backend.

Follow the [instructions here](https://github.com/KootumbOrg/kootumb-api#getting-started) and make sure the server is running.
...
```sh
git clone git@github.com:KootumbOrg/kootumb-app.git
cd kootumb-app
```
...
````json
{
   "API_URL": "<MANDATORY: The url of the kootumb-api backend>",
...
1. Add localization string get method to `kongo_app/lib/services/localizations.dart`
2. Run `make generate_locale`
3. Upload assets/i18n/en folder's contents to https://crowdin.com/project/kootumb/settings#files by pressing `Update` next to the existing files.
...
At Kootumb, we wanted to support different combinations of languages and country codes. For eg.
...
Help us keep Kootumb going! Please look into our open issues. All contribution, no matter how small, makes a big difference.
...
[Join our Slack channel](https://join.slack.com/t/kootumb/shared_invite/enQtNDI2NjI3MDM0MzA2LTYwM2E1Y2NhYWRmNTMzZjFhYWZlYmM2YTQ0MWEwYjYyMzcxMGI0MTFhNTIwYjU2ZDI1YjllYzlhOWZjZDc4ZWY), we're happy to help you troubleshoot your issue.


# Glossary

Have a term we use you would like an explanation for? [Let us know by opening an issue](https://github.com/KootumbOrg/kootumb-api/issues)!
