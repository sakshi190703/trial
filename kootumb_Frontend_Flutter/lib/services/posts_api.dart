...
class PostsApiService {
  ...
  Future<HttpieResponse> getTrendingPosts({
    ...
    return _httpService.get(
      '$apiURL$GET_TRENDING_POSTS_PATH',
      queryParameters: queryParams,
      appendAuthorizationToken: authenticatedRequest,
    );
  }
  ...
  Future<HttpieResponse> getCommentsForPostWithUuid(
    String postUuid, {
    int? countMax,
    int? maxId,
    int? countMin,
  ...
  Future<HttpieResponse> getReactionsForPostWithUuid(
    String postUuid, {
    int? count,
    int? maxId,
    int? emojiId,
  ...
  Future<HttpieResponse> getTopPostsExcludedCommunities({
    ...
    return _httpService.get(
      '$apiURL$EXCLUDED_TOP_POSTS_COMMUNITIES_PATH',
      appendAuthorizationToken: authenticatedRequest,
  ...
  String _makeExcludedCommunityFromTopPostsPath(String communityName) {
    return _stringTemplateService.parse(EXCLUDED_TOP_POSTS_COMMUNITY_PATH, {
  ...
  Future<HttpieResponse> linkIsPreviewable({required String link}) {
    ...
    return _httpService.postJSON(
      _makeApiUrl(LINK_IS_PREVIEWABLE_PATH),
      body: body,
      appendAuthorizationToken: true,
    );
  }
  ...
  String _makeUnmutePostPath(String postUuid) {
    return _stringTemplateService.parse(UNMUTE_POST_PATH, {
      'postUuid': postUuid,
    });
  }
  ...
  String _makeDisableCommentsForPostPath(String postUuid) {
    return _stringTemplateService.parse(DISABLE_POST_COMMENTS_PATH, {
      'postUuid': postUuid,
    });
  }

  String _makeEnableCommentsForPostPath(String postUuid) {
    return _stringTemplateService.parse(ENABLE_POST_COMMENTS_PATH, {
      'postUuid': postUuid,
    });
  }
  ...
  String _makeClosePostPath(String postUuid) {
    return _stringTemplateService.parse(CLOSE_POST_PATH, {
      'postUuid': postUuid,
    });
  }

  String _makeCommentPostPath(String postUuid) {
    return _stringTemplateService.parse(COMMENT_POST_PATH, {
      'postUuid': postUuid,
    });
  }
  ...
  String _makeGetPostCommentsPath(String postUuid) {
    return _stringTemplateService.parse(GET_POST_COMMENTS_PATH, {
      'postUuid': postUuid,
    });
  }
  ...
  String _makeReactToPostPath(String postUuid) {
    return _stringTemplateService.parse(REACT_TO_POST_PATH, {
      'postUuid': postUuid,
    });
  }

  String _makeGetPostParticipantsPath(String postUuid) {
    return _stringTemplateService.parse(GET_POST_PARTICIPANTS_PATH, {
      'postUuid': postUuid,
    });
  }

  String _makeSearchPostParticipantsPath(String postUuid) {
    return _stringTemplateService.parse(SEARCH_POST_PARTICIPANTS_PATH, {
      'postUuid': postUuid,
    });
  }

  String _makeGetPostReactionsPath(String postUuid) {
    return _stringTemplateService.parse(GET_POST_REACTIONS_PATH, {
      'postUuid': postUuid,
    });
  }
  ...
  String _makeGetPostReactionsEmojiCountPath(String postUuid) {
    return _stringTemplateService.parse(GET_POST_REACTIONS_EMOJI_COUNT_PATH, {
      'postUuid': postUuid,
    });
  }
  ...
  String _makeReportPostPath({required postUuid}) {
    return _stringTemplateService.parse(REPORT_POST_PATH, {
      'postUuid': postUuid,
    });
  }

  String _makeTranslatePostPath({required postUuid}) {
    return _stringTemplateService.parse(TRANSLATE_POST_PATH, {
      'postUuid': postUuid,
    });
  }

  String _makePreviewPostDataPath({required postUuid}) {
    return _stringTemplateService.parse(PREVIEW_POST_DATA_PATH, {
      'postUuid': postUuid,
    });
  }

  String _makeAddPostMediaPath({required postUuid}) {
    return _stringTemplateService.parse(POST_MEDIA_PATH, {
      'postUuid': postUuid,
    });
  }
  ...
  String _makePublishPostPath({required postUuid}) {
    return _stringTemplateService.parse(PUBLISH_POST_PATH, {
      'postUuid': postUuid,
    });
  }

  String _makeGetPostStatusPath({required postUuid}) {
    return _stringTemplateService.parse(GET_POST_STATUS_PATH, {
      'postUuid': postUuid,
    });
  }
