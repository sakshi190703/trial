import 'dart:async';
import 'package:Kootumb/services/universal_links/handlers/create_account_link.dart';
import 'package:Kootumb/services/universal_links/handlers/email_verification_link.dart';
import 'package:Kootumb/services/universal_links/handlers/password_reset_link.dart';
import 'package:flutter/cupertino.dart';

class UniversalLinksService {
  late StreamSubscription _universalLinksLibSubscription;
  final List<UniversalLinkHandler> _universalLinksHandlers = [
  ...
  void digestLinksWithContext(BuildContext context) {
    ...
    for (var link in _universalLinksQueue) {
      _digestLinkWithContext(link: link, context: context);
    }
  ...
  void _digestLinkWithContext(
    ...
    for (var handler in _universalLinksHandlers) {
      handler.handle(context: context, link: link);
    }
  }
  ...
  Stream<String?> getLinksStream() {
    // TODO: Replace with actual implementation for universal/deep links
