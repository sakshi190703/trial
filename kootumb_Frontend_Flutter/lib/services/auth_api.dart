...
class AuthApiService {
  ...
  Future<HttpieStreamedResponse> updateUser({
    ...
    return _httpService.patchMultiform(
      '$apiURL$UPDATE_AUTHENTICATED_USER_PATH',
      body: body,
      appendAuthorizationToken: true,
    );
  }
  ...
  Future<HttpieResponse> getUserWithAuthToken(String authToken) {
    ...
    return _httpService.get(
      '$apiURL$GET_AUTHENTICATED_USER_PATH',
      headers: headers,
    );
  }

  Future<HttpieResponse> getUserWithUsername(
    String username, {
    bool authenticatedRequest = true,
  }) {
    return _httpService.get(
      '$apiURL$GET_USERS_PATH$username/',
      appendAuthorizationToken: authenticatedRequest,
    );
  }

  Future<HttpieResponse> getPostsCountForUserWithName(
    String username, {
    bool authenticatedRequest = true,
  }) {
    return _httpService.get(
      '$apiURL$GET_USERS_PATH$username/posts/count/',
      appendAuthorizationToken: authenticatedRequest,
    );
  }

  Future<HttpieResponse> getUsersWithQuery(
    String query, {
    bool authenticatedRequest = true,
  }) {
    return _httpService.get(
      '$apiURL$GET_USERS_PATH',
  ...
  Future<HttpieResponse> searchLinkedUsers({
    ...
    return _httpService.get(
      '$apiURL$SEARCH_LINKED_USERS_PATH',
  ...
  Future<HttpieResponse> searchBlockedUsers({
    ...
    return _httpService.get(
      '$apiURL$SEARCH_BLOCKED_USERS_PATH',
      queryParameters: queryParams,
      appendAuthorizationToken: true,
    );
  }
  ...
  Future<HttpieResponse> enableNewPostNotificationsForUserWithUsername(
    ...
    String path = _makeEnableNewPostNotificationsForUserWithUsernamePath(
      userUsername,
    );
  ...
  Future<HttpieResponse> requestPasswordReset({required String email}) {
    ...
    return _httpService.postJSON(
      '$apiURL$REQUEST_RESET_PASSWORD_PATH',
      body: body,
    );
  }
  ...
  Future<HttpieResponse> verifyPasswordReset({
    ...
    return _httpService.postJSON(
      '$apiURL$VERIFY_RESET_PASSWORD_PATH',
  ...
  String _makeBlockUserWithUsernamePath(String username) {
    return _stringTemplateService.parse(BLOCK_USER_PATH, {
      'userUsername': username,
    });
  }

  String _makeUnblockUserWithUsernamePath(String username) {
    return _stringTemplateService.parse(UNBLOCK_USER_PATH, {
      'userUsername': username,
    });
  }
  ...
  String _makeReportUserPath({required username}) {
    return _stringTemplateService.parse(REPORT_USER_PATH, {
      'userUsername': username,
    });
  }
