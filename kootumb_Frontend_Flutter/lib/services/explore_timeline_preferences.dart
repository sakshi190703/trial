...
class ExploreTimelinePreferencesService {
  ...
  static const excludeJoinedCommunitiesStorageKey =
      'excludeJoinedCommunitiesSetting';
  ...
  final _excludeJoinedCommunitiesSettingChangeSubject = BehaviorSubject<bool>();
  ...
  Future setExcludeJoinedCommunitiesSetting(
      bool excludeJoinedCommunitiesSetting) async {
  ...
  void _refreshExcludeJoinedCommunitiesEnabled() async {
    ...
    _excludeJoinedCommunitiesSettingChangeSubject
        .add(_isExcludeJoinedCommunitiesEnabled);
  }
