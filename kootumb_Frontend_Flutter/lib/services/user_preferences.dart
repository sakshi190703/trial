...
class UserPreferencesService {
  ...
  void bootstrap() async {
    ...
    _connectivityChangeSubscription = _connectivityService.onConnectivityChange(
      _onConnectivityChange,
    );

    HashtagsDisplaySetting? hashtagsDisplaySetting =
        await getHashtagsDisplaySetting();
  ...
  Future<LinkPreviewsSetting?> getLinkPreviewsSetting() async {
    String rawValue = (await _storage.get(
      linkPreviewsSettingStorageKey,
  ...
  Future<VideosAutoPlaySetting?> getVideosAutoPlaySetting() async {
    String rawValue = (await _storage.get(
      videosAutoPlaySettingStorageKey,
  ...
  Future<HashtagsDisplaySetting?> getHashtagsDisplaySetting() async {
    String rawValue = (await _storage.get(
      hashtagsDisplaySettingStorageKey,
...
class VideosAutoPlaySetting {
  ...
  static const never = VideosAutoPlaySetting._internal('n');
  static const always = VideosAutoPlaySetting._internal('a');
  static const wifiOnly = VideosAutoPlaySetting._internal('w');

  static const _values = <VideosAutoPlaySetting>[never, always, wifiOnly];

  static List<VideosAutoPlaySetting> values() => _values;
...
class VideosSoundSetting {
  ...
  static const enabled = VideosSoundSetting._internal('e');
  static const disabled = VideosSoundSetting._internal('d');

  static const _values = <VideosSoundSetting>[enabled, disabled];

  static List<VideosSoundSetting> values() => _values;
...
class LinkPreviewsSetting {
  ...
  static const never = LinkPreviewsSetting._internal('n');
  static const always = LinkPreviewsSetting._internal('a');
  static const wifiOnly = LinkPreviewsSetting._internal('w');

  static const _values = <LinkPreviewsSetting>[never, always, wifiOnly];

  static List<LinkPreviewsSetting> values() => _values;
...
class HashtagsDisplaySetting {
  ...
  static const traditional = HashtagsDisplaySetting._internal('t');
  static const disco = HashtagsDisplaySetting._internal('d');

  static const _values = <HashtagsDisplaySetting>[traditional, disco];

  static List<HashtagsDisplaySetting> values() => _values;
