...
class CommunitiesApiService {
  ...
  Future<HttpieResponse> checkNameIsAvailable({required String name}) {
    return _httpService.postJSON(
      '$apiURL$CHECK_COMMUNITY_NAME_PATH',
      body: {'name': name},
  ...
  Future<HttpieResponse> getTrendingCommunities({
    ...
    return _httpService.get(
      '$apiURL$GET_TRENDING_COMMUNITIES_PATH',
  ...
  Future<HttpieResponse> getSuggestedCommunities({
    ...
    return _httpService.get(
      '$apiURL$GET_SUGGESTED_COMMUNITIES_PATH',
      appendAuthorizationToken: authenticatedRequest,
    );
  }
  ...
  Future<HttpieResponse> getPostsForCommunityWithName(
    String communityName, {
    int? maxId,
    int? count,
    bool authenticatedRequest = true,
  ...
  Future<HttpieResponse> getPostsCountForCommunityWithName(
    String communityName, {
    bool authenticatedRequest = true,
  }) {
  ...
  Future<HttpieResponse> searchCommunitiesWithQuery({
    ...
    return _httpService.get(
      '$apiURL$SEARCH_COMMUNITIES_PATH',
      queryParameters: queryParams,
      appendAuthorizationToken: authenticatedRequest,
    );
  }

  Future<HttpieResponse> getCommunityWithName(
    String name, {
    bool authenticatedRequest = true,
  }) {
  ...
  Future<HttpieStreamedResponse> createCommunity({
    ...
    return _httpService.putMultiform(
      _makeApiUrl(CREATE_COMMUNITY_PATH),
      body: body,
      appendAuthorizationToken: true,
    );
  }

  Future<HttpieStreamedResponse> updateCommunityWithName(
    String communityName, {
    String? name,
    String? title,
  ...
  Future<HttpieResponse> getMembersForCommunityWithId(
    String communityName, {
    int? count,
    int? maxId,
    List<String>? exclude,
  ...
  Future<HttpieResponse> getJoinedCommunities({
    ...
    return _httpService.get(
      '$apiURL$GET_JOINED_COMMUNITIES_PATH',
      appendAuthorizationToken: authenticatedRequest,
      queryParameters: queryParams,
    );
  }
  ...
  Future<HttpieResponse> searchJoinedCommunities({
    ...
    return _httpService.get(
      _makeApiUrl(SEARCH_JOINED_COMMUNITIES_PATH),
      queryParameters: queryParams,
      appendAuthorizationToken: true,
    );
  }
  ...
  Future<HttpieResponse> getModeratorsForCommunityWithId(
    String communityName, {
    int? count,
    int? maxId,
  }) {
  ...
  Future<HttpieResponse> removeCommunityAdministrator({
    ...
    String path = _makeRemoveCommunityAdministratorPath(
      communityName,
      username,
    );
    return _httpService.delete(
  ...
  Future<HttpieResponse> getBannedUsersForCommunityWithId(
    String communityName, {
    int? count,
    int? maxId,
  }) {
  ...
  Future<HttpieResponse> getFavoriteCommunities({
    ...
    return _httpService.get(
      '$apiURL$GET_FAVORITE_COMMUNITIES_PATH',
      appendAuthorizationToken: authenticatedRequest,
  ...
  Future<HttpieResponse> searchFavoriteCommunities({
    ...
    return _httpService.get(
      '$apiURL$SEARCH_FAVORITE_COMMUNITIES_PATH',
      queryParameters: queryParams,
      appendAuthorizationToken: true,
    );
  }
  ...
  Future<HttpieResponse> enableNewPostNotificationsForCommunity({
    ...
    String path = _makeEnableNewPostNotificationsForCommunityPath(
      communityName,
    );
    return _httpService.putJSON(
      _makeApiUrl(path),
  ...
  Future<HttpieResponse> getAdministratedCommunities({
    ...
    return _httpService.get(
      '$apiURL$GET_ADMINISTRATED_COMMUNITIES_PATH',
      appendAuthorizationToken: authenticatedRequest,
      queryParameters: {'offset': offset},
    );
  }
  ...
  Future<HttpieResponse> searchAdministratedCommunities({
    ...
    return _httpService.get(
      '$apiURL$SEARCH_ADMINISTRATED_COMMUNITIES_PATH',
      queryParameters: queryParams,
      appendAuthorizationToken: true,
    );
  }
  ...
  Future<HttpieResponse> searchModeratedCommunities({
    ...
    return _httpService.get(
      '$apiURL$SEARCH_MODERATED_COMMUNITIES_PATH',
      queryParameters: queryParams,
      appendAuthorizationToken: true,
    );
  }
  ...
  Future<HttpieResponse> getModeratedCommunities({
    ...
    return _httpService.get(
      '$apiURL$GET_MODERATED_COMMUNITIES_PATH',
      appendAuthorizationToken: authenticatedRequest,
      queryParameters: {'offset': offset},
    );
  }
  ...
  String _makeGetCommunityModeratedObjectsPath(String communityName) {
    return _stringTemplateService.parse(GET_COMMUNITY_MODERATED_OBJECTS_PATH, {
      'communityName': communityName,
    });
  }

  String _makeCreateCommunityPost(String communityName) {
    return _stringTemplateService.parse(CREATE_COMMUNITY_POST_PATH, {
      'communityName': communityName,
    });
  }

  String _makeReportCommunityPath(String communityName) {
    return _stringTemplateService.parse(REPORT_COMMUNITY_PATH, {
      'communityName': communityName,
    });
  }

  String _makeClosedCommunityPostsPath(String communityName) {
    return _stringTemplateService.parse(CLOSED_COMMUNITY_POSTS_PATH, {
      'communityName': communityName,
    });
  }

  String _makeInviteUserToCommunityPath(String communityName) {
    return _stringTemplateService.parse(INVITE_USER_TO_COMMUNITY_PATH, {
      'communityName': communityName,
    });
  }

  String _makeUninviteUserToCommunityPath(String communityName) {
    return _stringTemplateService.parse(UNINVITE_USER_TO_COMMUNITY_PATH, {
      'communityName': communityName,
    });
  }

  String _makeUnbanCommunityUserPath(String communityName) {
    return _stringTemplateService.parse(UNBAN_COMMUNITY_USER_PATH, {
      'communityName': communityName,
    });
  }

  String _makeBanCommunityUserPath(String communityName) {
    return _stringTemplateService.parse(BAN_COMMUNITY_USER_PATH, {
      'communityName': communityName,
    });
  }

  String _makeSearchCommunityBannedUsersPath(String communityName) {
    return _stringTemplateService.parse(SEARCH_COMMUNITY_BANNED_USERS_PATH, {
      'communityName': communityName,
    });
  }

  String _makeDeleteCommunityPath(String communityName) {
    return _stringTemplateService.parse(DELETE_COMMUNITY_PATH, {
      'communityName': communityName,
    });
  }

  String _makeGetCommunityPath(String communityName) {
    return _stringTemplateService.parse(GET_COMMUNITY_PATH, {
      'communityName': communityName,
    });
  }
  ...
  String _makeGetCommunityPostsPath(String communityName) {
    return _stringTemplateService.parse(GET_COMMUNITY_POSTS_PATH, {
      'communityName': communityName,
    });
  }

  String _makeGetPostsCountForCommunityWithNamePath(String communityName) {
    return _stringTemplateService.parse(COUNT_COMMUNITY_POSTS_PATH, {
      'communityName': communityName,
    });
  }

  String _makeFavoriteCommunityPath(String communityName) {
    return _stringTemplateService.parse(FAVORITE_COMMUNITY_PATH, {
      'communityName': communityName,
    });
  }
  ...
  String _makeJoinCommunityPath(String communityName) {
    return _stringTemplateService.parse(JOIN_COMMUNITY_PATH, {
      'communityName': communityName,
    });
  }

  String _makeLeaveCommunityPath(String communityName) {
    return _stringTemplateService.parse(LEAVE_COMMUNITY_PATH, {
      'communityName': communityName,
    });
  }

  String _makeUpdateCommunityPath(String communityName) {
    return _stringTemplateService.parse(UPDATE_COMMUNITY_PATH, {
      'communityName': communityName,
    });
  }

  String _makeCommunityAvatarPath(String communityName) {
    return _stringTemplateService.parse(COMMUNITY_AVATAR_PATH, {
      'communityName': communityName,
    });
  }

  String _makeCommunityCoverPath(String communityName) {
    return _stringTemplateService.parse(COMMUNITY_COVER_PATH, {
      'communityName': communityName,
    });
  }

  String _makeGetCommunityMembersPath(String communityName) {
    return _stringTemplateService.parse(GET_COMMUNITY_MEMBERS_PATH, {
      'communityName': communityName,
    });
  }

  String _makeSearchCommunityMembersPath(String communityName) {
    return _stringTemplateService.parse(SEARCH_COMMUNITY_MEMBERS_PATH, {
      'communityName': communityName,
    });
  }

  String _makeGetCommunityBannedUsersPath(String communityName) {
    return _stringTemplateService.parse(GET_COMMUNITY_BANNED_USERS_PATH, {
      'communityName': communityName,
    });
  }

  String _makeGetCommunityAdministratorsPath(String communityName) {
    return _stringTemplateService.parse(GET_COMMUNITY_ADMINISTRATORS_PATH, {
      'communityName': communityName,
    });
  }

  String _makeSearchCommunityAdministratorsPath(String communityName) {
    return _stringTemplateService.parse(SEARCH_COMMUNITY_ADMINISTRATORS_PATH, {
      'communityName': communityName,
    });
  }

  String _makeGetCommunityModeratorsPath(String communityName) {
    return _stringTemplateService.parse(GET_COMMUNITY_MODERATORS_PATH, {
      'communityName': communityName,
    });
  }

  String _makeSearchCommunityModeratorsPath(String communityName) {
    return _stringTemplateService.parse(SEARCH_COMMUNITY_MODERATORS_PATH, {
      'communityName': communityName,
    });
  }
