...
import 'package:Kootumb/locale/messages_all.dart';
...
class LocalizationService {
  ...
  static LocalizationService of(BuildContext context) {
    late StreamSubscription onLoggedInUserChangeSubscription;
    var kongoProvider = KongoProvider.of(context);
    onLoggedInUserChangeSubscription =
        kongoProvider.userService.loggedInUserChange.listen((User? newUser) {
      String? userLanguageCode = newUser != null && newUser.hasLanguage()
          ? newUser.language?.code
          : null;
      Locale currentLocale = Localizations.localeOf(context);
      if (supportedLanguages.contains(userLanguageCode) &&
          userLanguageCode != currentLocale.languageCode) {
        Locale supportedMatchedLocale = supportedLocales.firstWhere(
          (Locale locale) => locale.languageCode == userLanguageCode,
        );
        print(
          'Overriding locale $currentLocale with user locale: $supportedMatchedLocale',
        );
        MyApp.setLocale(context, supportedMatchedLocale);
      }
      onLoggedInUserChangeSubscription.cancel();
    });
  ...
  String get auth__create_acc__legal_confirmation_desc {
    return Intl.message(
      "By registering in Kootumb, I certify that I'm older than 16 years old and have read the Community Guidelines, Privacy Policy and Terms of Use and agree to all of the items included",
  ...
  String get auth__create_acc__legal_desc_extra {
    return Intl.message(
      "They contain important information about your experience in Kootumb and you will have to accept to them",
  ...
  String get drawer__main_title {
    return Intl.message("my kootumb", name: 'drawer__main_title');
  }
  ...
  String get drawer__useful_links_terms_of_use_desc {
    return Intl.message(
      "The legal agreement between you and Kootumb you must abide to in order to have access to the platform",
  ...
  String error__receive_share_text_too_long(int limit) {
    return Intl.message(
      "Text is too long (limit: $limit characters)",
      args: [limit],
      name: 'error__receive_share_text_too_long',
    );
  }
  ...
  String community__pick_atleast_min_category(int min) {
    return Intl.message(
      "You must pick at least $min category.",
      args: [min],
  ...
  String community__pick_atleast_min_categories(int min) {
    return Intl.message(
      "You must pick at least $min categories.",
      args: [min],
      desc:
  ...
  String community__save_community_name_taken(String takenName) {
    return Intl.message(
      "Community name '$takenName' is taken",
      args: [takenName],
  ...
  String user_search__no_hashtags_for(String searchQuery) {
    return Intl.message(
      ...
      args: [searchQuery],
      name: 'user_search__no_hashtags_for',
    );
  }
  ...
  String post__user_has_not_shared_anything(String name) {
    return Intl.message(
      "$name has not shared anything yet.",
      args: [name],
  ...
  String user__profile_user_sent_follow_request(String userUsername) {
    return Intl.message(
      '@$userUsername has sent you a follow request.',
      args: [userUsername],
      name: 'user__profile_user_sent_follow_request',
    );
  }

  String user__profile_user_sent_connection_request(String userUsername) {
    return Intl.message(
      '@$userUsername has sent you a connection request.',
      args: [userUsername],
  ...
  String user__profile_kootumb_age_toast(String age) {
    return Intl.message(
      "On Kootumb since $age",
      args: [age],
      name: 'user__profile_kootumb_age_toast',
    );
  }
  ...
  String get user__manage_profile_follow_requests_desc {
    return Intl.message(
      "See all your received follow requests.",
  ...
  String get user__manage_profile_visibility_title_desc {
    return Intl.message(
      "Change whether your profile content is public, private or restricted to Kootumb members.",
  ...
  String user__edit_profile_pick_image_error_too_large(int limit) {
    return Intl.message(
      "Image too large (limit: $limit MB)",
      args: [limit],
  ...
  String user__confirm_connection_with(String userName) {
    return Intl.message(
      "Confirm connection with $userName",
      args: [userName],
  ...
  String user__invites_pending_email(String email) {
    return Intl.message(
      "Pending, invite email sent to $email",
      args: [email],
  ...
  String get user__visibility_kootumb {
    return Intl.message("kootumb", name: 'user__visibility_kootumb');
  }

  String get user__visibility_kootumb_desc {
    return Intl.message(
      "Only members of Kootumb can see your profile.",
      name: 'user__visibility_kootumb_desc',
    );
  }
  ...
  String get notifications__follow_request_desc {
    return Intl.message(
      "Be notified when someone wants to follow you.",
  ...
  String get notifications__follow_request_tile {
    return Intl.message(
      "[name] [username] wants to follow you.",
  ...
  String get notifications__approved_follow_request_tile {
    return Intl.message(
      "[name] [username] approved your follow request.",
  ...
  String notifications__user_community_invite_tile(String communityName) {
    return Intl.message(
      ...
      args: [communityName],
      desc: "Eg.: James @jamest has invited you to join community c/kootumb.",
  ...
  String notifications__community_new_post_tile(String communityName) {
    return Intl.message(
      ...
      args: [communityName],
      desc: "Eg.: There was a new post in c/kootumb.",
  ...
  String image_picker__error_too_large(int limit) {
    return Intl.message(
      "File too large (limit: $limit MB)",
      args: [limit],
      name: 'image_picker__error_too_large',
    );
  }
