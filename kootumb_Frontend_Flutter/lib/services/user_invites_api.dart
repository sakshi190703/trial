...
class UserInvitesApiService {
  ...
  Future<HttpieStreamedResponse> createUserInvite({required String nickname}) {
    Map<String, dynamic> body = {};

    body['nickname'] = nickname;

    return _httpService.putMultiform(
      _makeApiUrl(CREATE_USER_INVITE_PATH),
      body: body,
  ...
  Future<HttpieStreamedResponse> updateUserInvite({
    ...
    String path = _stringTemplateService.parse(UPDATE_USER_INVITE_PATH, {
  ...
  Future<HttpieResponse> getUserInvites({
    ...
    return _httpService.get(
      _makeApiUrl(GET_USER_INVITES_PATH),
  ...
  Future<HttpieResponse> searchUserInvites({
    ...
    return _httpService.get(
      _makeApiUrl(SEARCH_USER_INVITES_PATH),
      queryParameters: queryParams,
      appendAuthorizationToken: true,
    );
  }
  ...
  Future<HttpieResponse> deleteUserInvite(int userInviteId) {
    String path = _stringTemplateService.parse(DELETE_INVITE_PATH, {
      'userInviteId': userInviteId,
    });
  ...
  Future<HttpieResponse> emailUserInvite({
    ...
    String path = _stringTemplateService.parse(EMAIL_INVITE_PATH, {
      'userInviteId': userInviteId,
    });
    Map<String, dynamic> body = {};
