...
class OBUpdateConnectionWithUserTile extends StatefulWidget {
  ...
  const OBUpdateConnectionWithUserTile(this.user, {Key? key}) : super(key: key);
...
class OBUpdateConnectionWithUserTileState
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
        title: OBText(_localizationService
            .trans('user__update_connection_circles_title')),
  ...
  void _displayAddConnectionToCirclesBottomSheet() {
    ...
    _bottomSheetService.showConnectionsCirclesPicker(
        context: context,
        title:
            _localizationService.trans('user__update_connection_circles_title'),
        actionLabel:
            _localizationService.trans('user__update_connection_circle_save'),
    ...
    try {
      ...
      _toastService.success(
          message: _localizationService
              .trans('user__update_connection_circle_updated'),
          context: context);
    } catch (error) {
      _onError(error);
    }
