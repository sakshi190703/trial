import 'package:Kootumb/pages/home/pages/menu/pages/settings/pages/account_settings/modals/change-password/change_password.dart';
import 'package:Kootumb/pages/home/pages/menu/pages/settings/pages/account_settings/modals/change_email/change_email.dart';
...
class OBAccountSettingsPage extends StatelessWidget {
  const OBAccountSettingsPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    String? currentUserLanguage = userService.getUserLanguage()?.name;

    return CupertinoPageScaffold(
      backgroundColor: Color.fromARGB(0, 0, 0, 0),
      navigationBar: OBThemedNavigationBar(
        title: localizationService.drawer__settings,
