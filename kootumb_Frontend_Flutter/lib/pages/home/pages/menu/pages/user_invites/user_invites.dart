...
import 'package:Kootumb/pages/home/pages/menu/pages/user_invites/widgets/my_invite_group.dart';
import 'package:Kootumb/pages/home/pages/menu/pages/user_invites/widgets/user_invite_count.dart';
...
class OBUserInvitesPage extends StatefulWidget {
  const OBUserInvitesPage({Key? key}) : super(key: key);
...
class OBUserInvitesPageState extends State<OBUserInvitesPage> {
  ...
  Widget _buildNoInvitesFallback() {
    ...
    VoidCallback onPressed =
        hasInvites ? _onWantsToCreateInvite : _refreshInvites;
...
typedef OnWantsToCreateUserInvite = Future<UserInvite> Function();
typedef OnWantsToEditUserInvite = Future<UserInvite> Function(
    UserInvite userInvite);
typedef OnWantsToSeeUserInvite = void Function(UserInvite userInvite);
