...
import 'package:Kootumb/pages/home/pages/menu/pages/user_invites/widgets/user_invite_tile.dart';
...
class OBMyInvitesGroupState extends State<OBMyInvitesGroup> {
  ...
  Widget _buildInviteTile(BuildContext context, UserInvite userInvite) {
    onUserInviteDeletedCallback() {
      ...
      if (_inviteGroupList.isEmpty) _refreshInvites();
    }
...
typedef OBMyInvitesGroupRetry = Future<void> Function();

typedef OBMyInvitesGroupFallbackBuilder = Widget Function(
