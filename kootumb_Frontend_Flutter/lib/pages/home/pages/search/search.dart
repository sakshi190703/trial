...
import 'package:Kootumb/pages/home/pages/search/widgets/top_posts/top_posts.dart';
import 'package:Kootumb/pages/home/pages/search/widgets/trending_posts.dart';
import 'package:Kootumb/services/localization.dart';
import 'package:Kootumb/services/navigation_service.dart';
import 'package:Kootumb/pages/home/pages/search/widgets/search_results.dart';
...
class OBMainSearchPageState extends State<OBMainSearchPage>
  ...
  void initState() {
    ...
    _setScrollPositionThrottler =
        Throttling(duration: Duration(milliseconds: 300));
  ...
  double _getExtraPaddingForSlidableSection() {
    ...
    if (existingMediaQuery.padding.top != 0 &&
        existingMediaQuery.padding.bottom != 0) {
      return 20.0;
    }
    return 0.0;
  }
  ...
  Widget _createSearchBarAndTabsOverlay() {
    ...
    return Positioned(
        ...
        height: HEIGHT_SEARCH_BAR +
            _heightTabs * 1.2 +
            (_extraPaddingForSlidableSection ?? 0),
