...
class OBCommunityModeratorsPageState extends State<OBCommunityModeratorsPage> {
  ...
  void _onCommunityModeratorListItemDeleted(User communityModerator) async {
    try {
  ...
  Future<List<User>> _loadMoreCommunityModerators(
    ...
    var moreCommunityModerators = (await _userService.getModeratorsForCommunity(
      widget.community,
...
typedef OnWantsToCreateCommunityModerator = Future<User> Function();
typedef OnWantsToEditCommunityModerator = Future<User> Function(
    User communityModerator);
typedef OnWantsToSeeCommunityModerator = void Function(User communityModerator);
