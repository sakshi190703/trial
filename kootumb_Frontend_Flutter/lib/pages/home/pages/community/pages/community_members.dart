...
class OBCommunityMembersPageState extends State<OBCommunityMembersPage> {
  ...
  Widget build(BuildContext context) {
    ...
    String title = widget.community.usersAdjective ??
        _localizationService.community__community_members;
    String singularName = widget.community.userAdjective ??
        _localizationService.community__member;
    String pluralName = widget.community.usersAdjective ??
