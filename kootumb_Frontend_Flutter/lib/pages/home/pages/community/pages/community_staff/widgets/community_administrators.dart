...
class OBCommunityAdministrators extends StatelessWidget {
  ...
  const OBCommunityAdministrators(this.community, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<Community> snapshot) {
        ...
        if (communityAdministrators!.isEmpty) return const SizedBox();
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ListView(
                    ...
                    shrinkWrap: true,
                    children: communityAdministrators.map((
