...
Widget _wrapWithBackground({
  ...
  if (updateSystemUiOverlay) {
    final bool darkBackground =
        backgroundColor != null && backgroundColor.computeLuminance() < 0.179;
        ...
        builder: (BuildContext context) {
          return Hero(
            ...
            child: _TransitionableNavigationBar(
              ...
              titleTextStyle: CupertinoTheme.of(
                context,
  ...
  Widget build(
    ...
    return Hero(
      ...
      child: _TransitionableNavigationBar(
        ...
        largeTitleTextStyle: CupertinoTheme.of(
          context,
        ).textTheme.navLargeTitleTextStyle,
        border: border,
...
class OBCupertinoNavigationBarBackButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle actionTextStyle = CupertinoTheme.of(
      context,
    ).textTheme.navActionTextStyle;
    if (color != null) {
...
class _NavigationBarComponentsTransition {
  ...
  RelativeRectTween slideFromLeadingEdge({
    ...
    Rect toRect = toBox
            .localToGlobal(Offset.zero, ancestor: toNavBarBox)
  ...
  Widget? get bottomMiddle {
    ...
    if ((bottomHasUserMiddle == null || !bottomHasUserMiddle!) &&
        bottomLargeExpanded) {
      return null;
    }
  ...
  Widget? get topMiddle {
    ...
    final RelativeRectTween positionTween = RelativeRectTween(
      begin: to.shift(
        Offset(forwardDirection * topNavBarBox.size.width / 2.0, 0.0),
      ),
      end: to,
    );
