...
import 'package:Kootumb/pages/home/pages/notifications/pages/general_notifications.dart';
import 'package:Kootumb/pages/home/pages/notifications/pages/request_notifications.dart';
...
import 'package:Kootumb/widgets/tiles/notification_tile/notification_tile.dart';
...
class OBNotificationsPageState extends State<OBNotificationsPage>
  ...
  late OBHttpListController<OBNotification>
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) async {
    if (state == AppLifecycleState.resumed) {
      _triggerRefreshNotifications(
          shouldScrollToTop: true,
          shouldUseRefreshIndicator: _isActivePage ?? false);
    }
  }
  ...
  void _markNotificationAsRead(OBNotification notification) {
    try {
      ...
      print('Couldnt mark notification as read with error: $error');
    }
  }
}
