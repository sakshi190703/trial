...
class OBNotificationsSettingsPage extends StatefulWidget {
  const OBNotificationsSettingsPage({Key? key}) : super(key: key);
...
class OBNotificationsSettingsPageState
  ...
  void _setNotificationsSettings(
    ...
    setState(() {
      ...
      _postCommentNotifications =
          notificationSettings.postCommentNotifications ?? false;
      ...
      _followRequestNotifications =
          notificationSettings.followRequestNotifications ?? false;
      _followRequestApprovedNotifications =
          notificationSettings.followRequestApprovedNotifications ?? false;
