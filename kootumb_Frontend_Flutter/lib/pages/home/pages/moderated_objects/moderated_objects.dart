...
import 'package:Kootumb/pages/home/pages/moderated_objects/widgets/moderated_object/moderated_object.dart';
import 'package:Kootumb/pages/home/pages/moderated_objects/widgets/no_moderated_objects.dart';
...
class OBModeratedObjectsPageState extends State<OBModeratedObjectsPage> {
  ...
  Widget _buildModeratedObject(BuildContext context, int index) {
    if (index == 0) {
      ...
      if (_moderatedObjects.isEmpty && !_refreshModeratedObjectsInProgress) {
        ...
        moderatedObjectItem = const SizedBox(height: 20);
      }
  ...
  void _onWantsToOpenFilters() {
    _modalService.openModeratedObjectsFilters(
      context: context,
      moderatedObjectsPageController: _controller,
    );
  }
