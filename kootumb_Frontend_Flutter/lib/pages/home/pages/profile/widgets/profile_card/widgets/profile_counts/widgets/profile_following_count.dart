...
class OBProfileFollowingCount extends StatelessWidget {
  ...
  const OBProfileFollowingCount(this.user, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    if (followingCount == 0) return const SizedBox();
                ...
                child: RichText(
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text:
                            localizationService.post__profile_counts_following,
                        style: TextStyle(
                          color: themeValueParserService.parseColor(
