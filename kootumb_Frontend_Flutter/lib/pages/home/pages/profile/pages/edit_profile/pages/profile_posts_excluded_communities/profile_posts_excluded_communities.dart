...
class OBProfilePostsExcludedCommunitiesState
  ...
  void _onExcludedCommunityListItemDeleted(Community excludedCommunity) async {
    try {
      await _userService.undoExcludeCommunityFromProfilePosts(
        excludedCommunity,
      );
  ...
  void _onWantsToExcludeCommunityFromProfilePosts() async {
    ...
    if (excludedCommunities!.isNotEmpty) {
      ...
      for (var excludedCommunity in excludedCommunities) {
        _httpListController.insertListItem(
          excludedCommunity,
  ...
  Future<List<Community>> _loadMoreExcludedCommunities(
    List<Community> excludedCommunitiesList,
  ) async {
