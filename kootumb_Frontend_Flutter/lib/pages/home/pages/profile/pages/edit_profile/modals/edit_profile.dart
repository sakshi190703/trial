...
class OBEditProfileModalState extends State<OBEditProfileModal> {
  ...
  void _showImageBottomSheet({required OBImageType imageType}) {
    ToastService toastService = KongoProvider.of(context).toastService;
        ...
        builder: (BuildContext context) {
          List<Widget> listTiles = [
            ListTile(
              ...
              title: Text(_localizationService.user__edit_profile_pick_image),
              onTap: () async {
                try {
            ...
            case OBImageType.cover:
              if (_coverUrl != null || _coverFile != null) {
                listTiles.add(ListTile(
                  ...
                  title: Text(_localizationService.user__edit_profile_delete),
                  onTap: () async {
                    _clearCover();
                    Navigator.pop(context);
                  },
