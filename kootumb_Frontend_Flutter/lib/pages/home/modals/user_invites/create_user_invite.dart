...
class OBCreateUserInviteModal extends StatefulWidget {
  ...
  const OBCreateUserInviteModal(
      {Key? key, this.userInvite, this.autofocusNameTextField = false})
      : super(key: key);
...
class OBCreateUserInviteModalState extends State<OBCreateUserInviteModal> {
  ...
  ObstructingPreferredSizeWidget _buildNavigationBar() {
    return OBThemedNavigationBar(
        ...
        title: _hasExistingUserInvite
            ? _localizationService.user__invites_create_edit_title
        ...
        trailing: OBButton(
          ...
          child: _hasExistingUserInvite
              ? Text(_localizationService.user__invites_create_save)
