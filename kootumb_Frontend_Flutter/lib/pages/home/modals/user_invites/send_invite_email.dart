...
class OBSendUserInviteEmailModal extends StatefulWidget {
  ...
  const OBSendUserInviteEmailModal(
      {Key? key, this.userInvite, this.autofocusEmailTextField = false})
      : super(key: key);
...
class OBSendUserInviteEmailModalState
  ...
  void _submitForm() async {
    ...
    try {
      _emailOperation = CancelableOperation.fromFuture(_userService
          .sendUserInviteEmail(widget.userInvite!, _emailController.text));
  ...
  void _showUserInviteSent() {
    _toastService.success(
        message: _localizationService.user__invites_email_sent_text,
        context: context);
  }
