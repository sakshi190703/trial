...
class OBSharePostWithCirclesPageState
  ...
  Widget _buildAvailableAudience() {
    return Column(
      ...
      children: <Widget>[
        ...
        Expanded(
            child: _circleSearchResults.isEmpty && _circleSearchQuery.isNotEmpty
                ? _buildNoResults()
                : _buildSearchResults())
      ],
    );
  ...
  ObstructingPreferredSizeWidget _buildNavigationBar() {
    return OBThemedNavigationBar(
      ...
      trailing: OBButton(
        ...
        isDisabled: _selectedCircles.isEmpty && !_fakeWorldCircleSelected,
  ...
  void _bootstrap() async {
    ...
    _setCircles(circleList.circles!);
  }
