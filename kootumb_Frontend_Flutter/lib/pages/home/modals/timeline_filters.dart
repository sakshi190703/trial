...
class OBTimelineFiltersModalState extends State<OBTimelineFiltersModal> {
          ...
          children: <Widget>[
            OBSearchBar(
              ...
              hintText: _localizationService
                  .trans('user__timeline_filters_search_desc'),
            ),
            Expanded(
                  ...
                  Expanded(
                    child: OBButton(
                      ...
                      child: Text(_localizationService
                          .trans('user__timeline_filters_clear_all')),
                    ),
                  ),
                  const SizedBox(
                    width: 20,
  ...
  Widget _buildApplyFiltersText() {
    String text =
        _localizationService.trans('user__timeline_filters_apply_all');
  ...
  Widget _buildSearchResults() {
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
                ...
                children: <Widget>[
                  OBTileGroupTitle(
                    title: _localizationService
                        .trans('user__timeline_filters_circles'),
                  ),
                  circleTile
                ],
              );
          ...
          Widget listTile = OBFollowsListTile(
          ...
          if (index == _circlesSearchResults.length) {
            listTile = Column(
              ...
              children: <Widget>[
                OBTileGroupTitle(
                  title: _localizationService
                      .trans('user__timeline_filters_lists'),
                ),
                listTile
              ],
            );
            ...
            children: <Widget>[
              ...
              OBText(
                _localizationService
                    .user__timeline_filters_no_match(_searchQuery ?? ''),
                style: TextStyle(
