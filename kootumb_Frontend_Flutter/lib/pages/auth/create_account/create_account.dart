...
class OBAuthCreateAccountPage extends StatefulWidget {
  const OBAuthCreateAccountPage({Key? key}) : super(key: key);
...
class OBAuthCreateAccountPageState extends State<OBAuthCreateAccountPage> {
  ...
  Widget _buildPasteRegisterLink({required BuildContext context}) {
    String pasteLinkText = _localizationService.trans(
  ...
  Widget _buildRequestInvite({required BuildContext context}) {
    String requestInviteText = _localizationService.trans(
  ...
  void _setTokenIsInvalid(bool tokenIsInvalid) {
    setState(() {
  ...
  void _setTokenValidationInProgress(bool tokenValidationInProgress) {
    setState(() {
