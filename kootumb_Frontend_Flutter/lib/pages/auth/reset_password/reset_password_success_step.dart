...
class OBAuthPasswordResetSuccessPage extends StatefulWidget {
  const OBAuthPasswordResetSuccessPage({Key? key}) : super(key: key);
...
class OBAuthPasswordResetSuccessPageState
    extends State<OBAuthPasswordResetSuccessPage> {
      ...
      body: Container(
        child: Center(
            child: SingleChildScrollView(
                child: _buildAllSet(localizationService))),
      ),
  ...
  Widget _buildAllSet(LocalizationService localizationService) {
    return Column(children: <Widget>[
      ...
      Text(
        localizationService.auth__reset_password_success_info,
        textAlign: TextAlign.center,
