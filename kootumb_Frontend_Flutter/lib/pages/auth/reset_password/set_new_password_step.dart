...
class OBAuthSetNewPasswordPage extends StatefulWidget {
  const OBAuthSetNewPasswordPage({Key? key}) : super(key: key);
...
class OBAuthSetNewPasswordPageState extends State<OBAuthSetNewPasswordPage> {
  ...
  Widget build(BuildContext context) {
    ...
    validationService = kongoProvider.validationService;
    createAccountBloc = kongoProvider.createAccountBloc;
    userService = kongoProvider.userService;
    toastService = kongoProvider.toastService;
  ...
  Future<void> _verifyResetPassword(BuildContext context) async {
    ...
    try {
      ...
      if (error is HttpieConnectionRefusedError) {
        _showErrorMessage(
          localizationService.trans('auth__login__connection_error'),
        );
      }
    } finally {
