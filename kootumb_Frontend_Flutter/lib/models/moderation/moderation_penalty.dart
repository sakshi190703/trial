...
class ModerationPenalty {
  ...
  static ModerationCategory? parseCategory(
      Map<String, dynamic>? rawModerationCategory) {
  ...
  static ModeratedObject? parseModeratedObject(
      Map<String, dynamic>? rawModeratedObject) {
