...
class NotificationType {
  ...
  static const postReaction = NotificationType._internal('PR');
  static const postComment = NotificationType._internal('PC');
  static const postCommentReply = NotificationType._internal('PCR');
  static const postCommentReaction = NotificationType._internal('PCRA');
  static const connectionRequest = NotificationType._internal('CR');
  static const connectionConfirmed = NotificationType._internal('CC');
  static const follow = NotificationType._internal('F');
  static const followRequest = NotificationType._internal('FR');
  static const followRequestApproved = NotificationType._internal('FRA');
  static const communityInvite = NotificationType._internal('CI');
  static const postCommentUserMention = NotificationType._internal('PCUM');
  static const postUserMention = NotificationType._internal('PUM');
  static const communityNewPost = NotificationType._internal('CNP');
  static const userNewPost = NotificationType._internal('UNP');

  static const _values = <NotificationType>[
    postReaction,
    postComment,
    postCommentReply,
    postCommentReaction,
  ...
  static List<NotificationType> values() => _values;
