...
class PostComment extends UpdatableModel<PostComment> {
  ...
  static String convertPostCommentSortTypeToString(PostCommentsSortType type) {
    String result;
    switch (type) {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'replies': replies?.comments
          ?.map((PostComment reply) => reply.toJson())
          .toList(),
  ...
  String? getCommenterName() {
    return commenter?.getProfileName();
  }

  String? getCommenterProfileAvatar() {
    return commenter?.getProfileAvatar();
  }
  ...
  void setReaction(PostCommentReaction? newReaction) {
    ...
    List<ReactionsEmojiCount?> newEmojiCounts =
        reactionsEmojiCounts?.counts != null
    ...
    _setReactionsEmojiCounts(ReactionsEmojiCountList(counts: newEmojiCounts));
...
class PostCommentFactory extends UpdatableModelFactory<PostComment> {
  ...
  PostCommentReaction? parseReaction(
      Map<String, dynamic>? postCommentReaction) {
