...
class UserInvite extends UpdatableModel<UserInvite> {
  ...
  static const String IOS_DOWNLOAD_LINK =
      'https://testflight.apple.com/join/XniAjdyF';
  static const String TESTFLIGHT_DOWNLOAD_LINK =
      'https://itunes.apple.com/us/app/testflight/id899247664';
  static const String ANDROID_DOWNLOAD_LINK =
      'https://play.google.com/store/apps/details?id=social.kongo.app';
  static const INVITE_LINK = '{apiURL}api/auth/invite?token={token}';

  static bool? convertUserInviteStatusToBool(UserInviteFilterByStatus value) {
    bool? isPending;
    switch (value) {
