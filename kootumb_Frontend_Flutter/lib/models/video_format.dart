...
class OBVideoFormatType {
  ...
  static const mp4SD = OBVideoFormatType._internal('mp4_sd');
  static const webmSD = OBVideoFormatType._internal('webm_sd');

  static const _values = <OBVideoFormatType>[
    mp4SD,
    webmSD,
  ];

  static List<OBVideoFormatType> values() => _values;
