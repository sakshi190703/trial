  ...
  static dynamic parseContentObject(
    ...
    switch (type) {
      case PostMediaType.image:
        contentObject = PostImage.fromJSON(contentObjectData);
        break;
...
class PostMediaType {
  ...
  static const video = PostMediaType._internal('V');
  static const image = PostMediaType._internal('I');

  static const _values = <PostMediaType>[
    video,
    image,
  ];

  static List<PostMediaType> values() => _values;
