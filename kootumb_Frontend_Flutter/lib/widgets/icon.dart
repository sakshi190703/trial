...
enum OBIconSize { small, medium, large, extraLarge, notVisi }
...
class OBIcon extends StatelessWidget {
  ...
  static const double NOT_VISI = 0.0;
  ...
  Widget build(BuildContext context) {
    ...
    var themeValueParser = KongoProvider.of(context).themeValueParserService;
...
class OBIcons {
  ...
  static const kootumb_age_baby = OBIconData(nativeIcon: Icons.child_care);
  static const kootumb_age_smile =
      OBIconData(nativeIcon: Icons.sentiment_satisfied);
  ...
  static const excludePostCommunity =
      OBIconData(nativeIcon: Icons.not_interested);
  ...
  static const visibilityKootumb = OBIconData(nativeIcon: Icons.people);
