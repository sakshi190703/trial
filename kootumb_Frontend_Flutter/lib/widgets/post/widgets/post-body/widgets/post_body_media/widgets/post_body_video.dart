...
import 'package:Kootumb/widgets/video_player/video_player.dart';
...
class OBPostVideoState extends State<OBPostBodyVideo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(children: <Widget>[Expanded(child: _buildVideoPlayer())]);
  }

  Widget _buildVideoPlayer() {
    OBVideoFormat videoFormat = widget.postVideo!.getVideoFormatOfType(
      OBVideoFormatType.mp4SD,
    )!;
