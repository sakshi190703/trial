...
import 'package:Kootumb/widgets/post/widgets/post_header/widgets/community_post_header/widgets/community_post_creator_identifier.dart';
            ...
            ? IconButton(
                ...
                onPressed: () {
                  bottomSheetService!.showPostActions(
                      ...
                      post: _post,
                      displayContext:
                          displayContext ?? OBPostDisplayContext.timelinePosts,
  ...
  Widget _buildUserHighlightHeader(
    ...
    return ListTile(
      leading: OBAvatar(
        ...
        onPressed: () {
          navigationService!
              .navigateToUserProfile(user: _post.creator!, context: context!);
        },
      ),
      trailing: hasActions
          ? IconButton(
