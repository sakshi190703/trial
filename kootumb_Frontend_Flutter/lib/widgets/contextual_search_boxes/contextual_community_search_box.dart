...
class OBContextualCommunitySearchBoxState
  ...
  Widget build(BuildContext context) {
    ...
    return OBPrimaryColorContainer(
      child: _searchQuery.isEmpty ? _buildAllList() : _buildSearchResultsList(),
    );
  }
      ...
      if (_searchInProgress) {
        ...
        return ListTile(
          leading: const Padding(
            ...
            child: OBIcon(OBIcons.sad),
          ),
          title: OBText(
            _localizationService.contextual_community_search_box__no_results,
          ),
        );
      } else {
  ...
  Future refreshAll() async {
    ...
    try {
      _getAllOperation = CancelableOperation.fromFuture(
        _userService.getJoinedCommunities(),
      );
