...
import 'package:Kootumb/widgets/contextual_search_boxes/contextual_account_search_box.dart';
import 'package:Kootumb/widgets/contextual_search_boxes/contextual_community_search_box.dart';
import 'package:Kootumb/widgets/contextual_search_boxes/contextual_hashtag_search_box.dart';
...
abstract class OBContextualSearchBoxState<T extends StatefulWidget>
  ...
  late OBContextualAccountSearchBoxController
  ...
  late OBContextualHashtagSearchBoxController
  ...
  void bootstrap() {
    ...
    _textAutocompletionService = kongoProvider.textAccountAutocompletionService;
  }
  ...
  void _checkForAutocomplete() {
    ...
    if (result != null && result.isAutocompleting) {
      debugLog(
          'Wants to autocomplete with type ${result.type} searchQuery:${result.autocompleteQuery ?? 'null'}');
