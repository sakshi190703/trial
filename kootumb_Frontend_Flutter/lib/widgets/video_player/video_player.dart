...
import 'package:Kootumb/widgets/video_player/widgets/video_player_controls.dart';
...
class OBVideoPlayerState extends State<OBVideoPlayer> {
    ...
    return Stack(
      children: <Widget>[
        ...
        Positioned(
          ...
          right: 0,
          left: 0,
          child: Center(child: OBProgressIndicator(color: Colors.white)),
        ),
      ],
    );
  }
  ...
  void _onExpandCollapse(Function originalExpandFunction) async {
    ...
    KongoProviderState kongoProvider = KongoProvider.of(context);
    await kongoProvider.dialogService.showVideo(
      context: context,
      video: widget.video,
