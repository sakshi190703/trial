...
class OBToast extends StatefulWidget {
  ...
  const OBToast({Key? key, this.child}) : super(key: key);
...
class _KongoToast extends InheritedWidget {
  const _KongoToast({Key? key, required Widget child})
      : super(key: key, child: child);

  @override
  bool updateShouldNotify(_KongoToast old) {
    return true;
  }
}
