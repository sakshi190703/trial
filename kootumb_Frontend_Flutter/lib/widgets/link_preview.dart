...
class OBLinkPreviewState extends State<OBLinkPreview> {
  ...
  Widget build(BuildContext context) {
    if (_needsBootstrap) {
      ...
      _httpieService = kongoProvider.httpService;
      _userPreferencesService = kongoProvider.userPreferencesService;
                        ...
                        children: [
                          ...
                          OBText(
                            _localizationService
                                .link_preview_failed__description,
                            textAlign: TextAlign.center,
                          ),
                          const SizedBox(
                            height: 20,
  ...
  Widget _buildCrossCompatImageForSource(String imageSource,
    ...
    String iconExtension = imageSource.split('.').last.toLowerCase();
