...
class OBCommunityTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ThemeService themeService = KongoProvider.of(context).themeService;
    ThemeValueParserService themeValueParserService = KongoProvider.of(
      context,
    ).themeValueParserService;
    Color communityColor = themeValueParserService.parseColor(
      communityHexColor,
    );
    ...
    bool isCommunityColorDark = themeValueParserService.isDarkColor(
      communityColor,
    );
    ...
    Widget communityTile = Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          trailing == null
              ? SizedBox(width: 20)
              : Padding(padding: const EdgeInsets.all(20), child: trailing),
        ],
      ),
    );
        ...
        endActionPane: ActionPane(
          ...
          children: [
            SlidableAction(
              ...
              foregroundColor: themeValueParserService.parseColor(
