...
class OBNewPostNotificationsForCommunityTileState
    extends State<OBNewPostNotificationsForCommunityTile> {
    ...
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<Community> snapshot) {
        ...
        bool areNotificationsEnabled =
            community?.areNewPostNotificationsEnabled ?? false;
  ...
  void _subscribeCommunity() async {
    ...
    try {
      await _userService
          .enableNewPostNotificationsForCommunity(widget.community);
  ...
  void _unsubscribeCommunity() async {
    ...
    try {
      await _userService
          .disableNewPostNotificationsForCommunity(widget.community);
      _toastService.success(
          message: _localizationService
