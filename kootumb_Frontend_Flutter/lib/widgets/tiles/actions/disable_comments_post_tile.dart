...
class OBDisableCommentsPostTileState extends State<OBDisableCommentsPostTile> {
    ...
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<Post> snapshot) {
        ...
        return ListTile(
          ...
          leading: OBIcon(areCommentsEnabled
              ? OBIcons.disableComments
              : OBIcons.enableComments),
  ...
  void _enableComments() async {
    ...
    try {
      ...
      _toastService.success(
          message: _localizationService.post__comments_enabled_message,
          context: context);
    } catch (e) {
      _onError(e);
    } finally {
  ...
  void _disableComments() async {
    ...
    try {
      ...
      _toastService.success(
          message: _localizationService.post__comments_disabled_message,
          context: context);
    } catch (e) {
      _onError(e);
    } finally {
