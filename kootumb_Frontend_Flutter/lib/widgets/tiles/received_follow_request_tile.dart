...
import 'package:Kootumb/widgets/buttons/actions/approve_follow_request_button.dart';
import 'package:Kootumb/widgets/buttons/actions/reject_follow_request_button.dart';
        ...
        children: [
          OBRejectFollowRequestButton(
            ...
            onFollowRequestRejected: () {
              if (onFollowRequestRejected != null) {
                onFollowRequestRejected!(followRequest);
              }
            },
          ...
          OBApproveFollowRequestButton(
            ...
            onFollowRequestApproved: () {
              if (onFollowRequestApproved != null) {
                onFollowRequestApproved!(followRequest);
              }
            },
            size: OBButtonSize.small,
          ),
