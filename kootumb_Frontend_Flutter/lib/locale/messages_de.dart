...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m11(min) => "Du musst mindestens ${min} Kategorien auswählen.";

  static String m12(min) => "Du musst mindestens ${min} Kategorie auswählen.";

  static String m13(max) => "Wähle bis zu ${max} Kategorien";
  ...
  static String m17(categoryName) => "Angesagt in ${categoryName}";

  static String m18(hashtag) =>
      "Du wirst der Erste sein, der #${hashtag} benutzt";

  static String m19(platform) => "Läuft auf ${platform}";

  static String m20(currentUserLanguage) => "Sprache (${currentUserLanguage})";

  static String m21(limit) => "Datei zu groß (Limit: ${limit} MB)";
  ...
  static String m31(commentsCount) =>
      "Alle ${commentsCount} Kommentare anzeigen";
  ...
  static String m34(name) => "${name} hat noch nichts geteilt.";

  static String m35(postCreatorUsername) => "@${postCreatorUsername}'s Kreise";
  ...
  static String m38(prettyUsersCount) => "${prettyUsersCount} Personen";

  static String m39(username) =>
      "Bist du dir sicher, dass du @${username} blockieren möchtest?";

  static String m40(userName) => "Verbindung mit ${userName} bestätigen";

  static String m41(userName) => "Mit ${userName} verbinden";

  static String m42(userName) => "Verbindung mit ${userName} trennen";

  static String m43(limit) => "Bild ist zu groß (Max: ${limit} MB)";

  static String m44(username) =>
      "Benutzername @${username} ist bereits vergeben";

  static String m45(searchQuery) => "Kein Emoji mit ${searchQuery} gefunden.";

  static String m46(searchQuery) => "Keine Liste zu '${searchQuery}' gefunden";

  static String m47(prettyUsersCount) => "${prettyUsersCount} Accounts";

  static String m48(prettyUsersCount) => "${prettyUsersCount} Accounts";

  static String m49(groupName) => "Alle ${groupName} anzeigen";

  static String m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Hey! Ich möchte dich zu Kootumb einladen.\n\nUnter Apple musst du dir zuerst die TestFlight App im AppStore (${testFlightLink}) und anschließend die Kootumb App (${iosLink}) herunterladen. \n\nUnter Android kannst du dir die App direkt im PlayStore (${androidLink}) herunterladen. \n\nFüge anschließend deinen personalisierten Einladungslink im 'Registrierungsformular' der Kootumb App ein: ${inviteLink}";

  static String m51(username) =>
      "Mit dem Benutzernamen @${username} beigetreten";

  static String m52(email) => "Ausstehend, Einladung an ${email} gesendet";
  ...
  static String m56(age) => "Auf Kootumb seit dem ${age}";

  static String m57(takenConnectionsCircleName) =>
      "Kreisname '${takenConnectionsCircleName}' bereits vergeben";

  static String m58(listName) => "Name der Liste ${listName} bereits vergeben";

  static String m59(searchQuery) => "Keine Ergebnisse für ${searchQuery}.";

  static String m60(resourcePluralName) =>
      "Keine ${resourcePluralName} gefunden.";

  static String m61(resourcePluralName) => "Suche ${resourcePluralName} ...";

  static String m62(searchQuery) =>
      "Keine Communities zu '${searchQuery}' gefunden.";

  static String m63(searchQuery) =>
      "Keine Hashtags zu '${searchQuery} ' gefunden.";

  static String m64(searchQuery) =>
      "Keine Suchergebnisse für '${searchQuery}'.";

  static String m65(searchQuery) =>
      "Keine Benutzer für '${searchQuery}' gefunden.";

  static String m66(searchQuery) => "Suche nach ${searchQuery}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Benutze den Link von dem Button \"Kootumb beitreten\" in deiner Einladungs-E-Mail."),
        ...
        "drawer__main_title":
            MessageLookupByLibrary.simpleMessage("Mein Kootumb"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Kootumb-Richtlinien"),
        ...
        "drawer__useful_links_guidelines_handbook":
            MessageLookupByLibrary.simpleMessage("Kootumb Handbuch"),
        "drawer__useful_links_guidelines_handbook_desc":
            MessageLookupByLibrary.simpleMessage(
                "Ein Benutzerhandbuch mit allem, was man wissen muss, um Kootumb zu nutzen"),
        ...
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "Hier kann man sich über Kootumb austauschen"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Unterstütze Kootumb"),
        ...
        "moderation__moderated_object_verified_by_staff":
            MessageLookupByLibrary.simpleMessage(
                "Geprüft durch das Kootumb-Team"),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "Du kannst Kootumb nicht benutzen, wenn du die Richtlinien nicht akzeptierst."),
        "user__confirm_guidelines_reject_join_slack":
            MessageLookupByLibrary.simpleMessage(
                "Trete Kootumb auf Slack bei."),
