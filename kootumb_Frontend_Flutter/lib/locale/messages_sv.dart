...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m18(currentUserLanguage) => "Språk (${currentUserLanguage})";

  static String m19(resourceCount, resourceName) =>
      "Visa alla ${resourceCount} ${resourceName}";

  static String m20(postCommentText) =>
      "[name] [username] kommenterade också: ${postCommentText}";

  static String m21(postCommentText) =>
      "[name] [username] kommenterade på ditt inlägg: ${postCommentText}";

  static String m22(postCommentText) =>
      "[name] [username] svarade också: ${postCommentText}";

  static String m23(postCommentText) =>
      "[name] [username] svarade: ${postCommentText}";

  static String m24(communityName) =>
      "[name] [username] har bjudit in dig till gemenskapen c/${communityName}.";

  static String m25(maxLength) =>
      "En kommentar kan inte vara längre än ${maxLength} tecken.";

  static String m26(commentsCount) => "Visa alla ${commentsCount} kommentarer";

  static String m27(circlesSearchQuery) =>
      "Inga kretsar hittades som matchar '${circlesSearchQuery}'.";

  static String m28(name) => "${name} har inte delat något ännu.";

  static String m29(postCreatorUsername) => "@${postCreatorUsername}s kretsar";

  static String m30(maxLength) =>
      "Kretsens namn får inte vara längre än ${maxLength} tecken.";

  static String m31(prettyUsersCount) => "${prettyUsersCount} personer";

  static String m32(username) =>
      "Är du säker på att du vill blockera @${username}?";

  static String m33(userName) => "Bekräfta ${userName}s kontaktförfrågan";

  static String m34(userName) => "Lägg till ${userName} som kontakt";

  static String m35(userName) => "Ta bort ${userName} som kontakt";

  static String m36(limit) => "Bilden är för stor (gräns: ${limit} MB)";

  static String m37(username) => "Användarnamnet @${username} är upptaget";

  static String m38(searchQuery) =>
      "Ingen emoji hittades som matchar '${searchQuery}'.";

  static String m39(searchQuery) => "Inga listor hittades för '${searchQuery}'";

  static String m40(prettyUsersCount) => "${prettyUsersCount} konton";

  static String m41(prettyUsersCount) => "${prettyUsersCount} Konton";

  static String m42(groupName) => "Visa alla ${groupName}";

  static String m43(iosLink, androidLink, inviteLink) =>
      "Hej, jag vill bjuda in dig till Kootumb. Först, ladda ner appen från iTunes (${iosLink}) eller Play Store (${androidLink}). Sedan klistrar du in din personliga inbjudningslänk i 'Registrera dig'-formuläret i Kootumb-appen: ${inviteLink}";

  static String m44(username) => "Gick med under användarnamnet @${username}";

  static String m45(email) => "Väntande, inbjudan skickad till ${email}";

  static String m46(maxLength) =>
      "Listans namn får inte vara längre än ${maxLength} tecken.";

  static String m47(maxLength) =>
      "Bion kan inte vara längre än ${maxLength} tecken.";

  static String m48(maxLength) =>
      "En plats kan inte vara längre än ${maxLength} tecken.";

  static String m49(takenConnectionsCircleName) =>
      "Kretsnamnet '${takenConnectionsCircleName}' är upptaget";

  static String m50(listName) => "Listnamnet '${listName}' är upptaget";

  static String m51(searchQuery) =>
      "Inga resultat hittades för '${searchQuery}'.";

  static String m52(resourcePluralName) =>
      "Inga ${resourcePluralName} hittades.";

  static String m53(resourcePluralName) => "Sök ${resourcePluralName} ...";

  static String m54(searchQuery) =>
      "Inga gemenskaper hittades för '${searchQuery}'.";

  static String m55(searchQuery) =>
      "Inga resultat hittades för '${searchQuery}'.";

  static String m56(searchQuery) =>
      "Inga användare hittades för '${searchQuery}'.";

  static String m57(searchQuery) => "Söker efter '${searchQuery}'";
