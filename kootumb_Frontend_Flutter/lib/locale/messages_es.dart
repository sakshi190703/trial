...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m18(currentUserLanguage) => "Idioma (${currentUserLanguage})";
  ...
  static String m26(commentsCount) => "Ver los ${commentsCount} comentarios";

  static String m27(circlesSearchQuery) =>
      "'No se han encontrado círculos que coincidan con '${circlesSearchQuery}'.";

  static String m28(name) => "${name} aún no ha compartido nada.";

  static String m29(postCreatorUsername) =>
  ...
  static String m31(prettyUsersCount) => "${prettyUsersCount} gente";

  static String m32(username) => "¿Seguro que quieres banear a @${username}?";

  static String m33(userName) => "Confirmar conexión con ${userName}";

  static String m34(userName) => "Conectar con ${userName}";

  static String m35(userName) => "Desconectarse de ${userName}";

  static String m36(limit) => "Imagen demasiado grande (límite: ${limit} MB)";

  static String m37(username) => "El nombre de usuario @${username} ya existe";

  static String m38(searchQuery) =>
      "No se encontró un Emoji similar a '${searchQuery}'.";

  static String m39(searchQuery) => "No se encontró lista con '${searchQuery}'";

  static String m40(prettyUsersCount) => "${prettyUsersCount} cuentas";

  static String m41(prettyUsersCount) => "${prettyUsersCount} Cuentas";

  static String m42(groupName) => "Ver ${groupName}";

  static String m43(iosLink, androidLink, inviteLink) =>
      "Hola, me gustaría invitarte a Kootumb. Primero, descarga la aplicación en iTunes (${iosLink}) on la PlayStore (${androidLink}). En segundo lugar, pega este enlace de invitación personalizado en el formulario 'Registrarse' en la aplicación Kootumb: ${inviteLink}";
  ...
  static String m50(listName) => "El nombre de lista '${listName}' esta tomado";

  static String m51(searchQuery) => "Sin resultados para '${searchQuery}'.";

  static String m52(resourcePluralName) =>
      "No se encontró ningun ${resourcePluralName}.";

  static String m53(resourcePluralName) => "Buscar ${resourcePluralName}...";

  static String m54(searchQuery) =>
      "No se encontraron comunidades para '${searchQuery}'.";

  static String m55(searchQuery) => "Sin resultados para \"${searchQuery}\".";

  static String m56(searchQuery) =>
      "No se encontraron usuarios para '${searchQuery}'.";

  static String m57(searchQuery) => "Buscando '${searchQuery}'";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Soporte Kootumb"),
