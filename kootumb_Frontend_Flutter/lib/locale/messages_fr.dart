...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(minLength, maxLength) =>
      "(${minLength}-${maxLength} caractères)";
  ...
  static String m7(username) =>
      "Êtes-vous sûr.e de vouloir bannir @${username} ?";
  ...
  static String m11(min) => "Vous devez choisir au moins ${min} catégories.";

  static String m12(min) => "Vous devez choisir au moins ${min} catégorie.";

  static String m13(max) => "Choisir jusqu'à ${max} catégories";

  static String m14(maxLength) =>
      "Les règles ne peuvent pas être plus longues que ${maxLength} caractères.";

  static String m15(takenName) =>
      "Le nom de communauté '${takenName}' est pris";

  static String m16(maxLength) =>
      "Le titre ne peut pas être plus long que ${maxLength} caractères.";

  static String m17(categoryName) =>
      "Communauté(s) tendance dans ${categoryName}";

  static String m18(hashtag) => "You'll be the first to use #${hashtag}";

  static String m19(platform) => "En cours d'exécution sur ${platform}";

  static String m20(currentUserLanguage) => "Langue (${currentUserLanguage})";

  static String m21(limit) => "Fichier trop lourd (limite : ${limit} Mo)";
  ...
  static String m31(commentsCount) =>
  ...
  static String m34(name) => "${name} n'a encore rien partagé.";

  static String m35(postCreatorUsername) => "cercles de ${postCreatorUsername}";
  ...
  static String m38(prettyUsersCount) => "${prettyUsersCount} personnes";

  static String m39(username) =>
      "Êtes-vous sûr.e de vouloir bloquer @${username}?";

  static String m40(userName) => "Confirmer la connexion avec ${userName}";

  static String m41(userName) => "Se connecter avec ${userName}";

  static String m42(userName) => "Se déconnecter de ${userName}";

  static String m43(limit) => "Image trop grande (limite : ${limit} Mo)";

  static String m44(username) => "Le pseudo @${username} est déjà pris";

  static String m45(searchQuery) =>
      "Aucune émoticône trouvée correspondant à '${searchQuery}'.";

  static String m46(searchQuery) =>
      "Aucune liste trouvée pour '${searchQuery}'";

  static String m47(prettyUsersCount) => "${prettyUsersCount} comptes";

  static String m48(prettyUsersCount) => "${prettyUsersCount} Comptes";

  static String m49(groupName) => "Voir tous.tes les ${groupName}";

  static String m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Salut, je voudrais t'inviter à Kootumb.\n\nPour Apple, télécharge d'abord l'application TestFlight sur iTunes (${testFlightLink}) puis télécharge l'application Kootumb (${iosLink})\n\nPour Android, télécharge-le depuis le Play Store (${androidLink}).\n\nPuis colle ce lien d'invitation personnalisé dans le formulaire 'S'inscrire' dans l'application Kootumb : ${inviteLink}";

  static String m51(username) =>
      "Inscrit.e avec le nom d'utilisateur.trice @${username}";

  static String m52(email) =>
      "En attente, courriel d'invitation envoyé à ${email}";
  ...
  static String m58(listName) => "Le nom de liste '${listName}' est pris";

  static String m59(searchQuery) => "Aucun résultat pour '${searchQuery}'.";

  static String m60(resourcePluralName) =>
      "Pas de ${resourcePluralName} trouvé.e.s.";

  static String m61(resourcePluralName) =>
      "Recherche ${resourcePluralName} ...";
  ...
  static String m64(searchQuery) => "Aucun résultat pour '${searchQuery}'.";

  static String m65(searchQuery) =>
      "Aucun.e utilisateur.trice trouvé.e pour '${searchQuery}'.";

  static String m66(searchQuery) => "Recherche de '${searchQuery}'";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Utilisez le lien du bouton « Rejoignez Kootumb » dans votre email d'invitation."),
        ...
        "drawer__application_settings":
            MessageLookupByLibrary.simpleMessage("Paramètres de l'application"),
        "drawer__connections":
        ...
        "drawer__main_title":
            MessageLookupByLibrary.simpleMessage("Mon Kootumb"),
        ...
        "drawer__useful_links_guidelines": MessageLookupByLibrary.simpleMessage(
            "Directives générales d'Kootumb"),
        ...
        "drawer__useful_links_guidelines_handbook":
            MessageLookupByLibrary.simpleMessage("Manuel d'Kootumb"),
        ...
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "Un endroit pour discuter de tout à propos d'Kootumb"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Supporter Kootumb"),
        ...
        "moderation__moderated_object_verified_by_staff":
            MessageLookupByLibrary.simpleMessage(
                "Vérifié par le personnel d'Kootumb"),
        ...
        "user__block_user":
            MessageLookupByLibrary.simpleMessage("Bloquer l'utilisateur.trice"),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "Vous ne pouvez pas utiliser Kootumb jusqu'à ce que vous acceptiez les lignes directrices."),
        "user__confirm_guidelines_reject_join_slack":
            MessageLookupByLibrary.simpleMessage(
                "Rejoignez le canal Slack d'Kootumb."),
        ...
        "user__timeline_filters_title":
            MessageLookupByLibrary.simpleMessage("Filtres du fil d'actualités"),
