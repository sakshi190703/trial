...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(username) =>
      "Är du säker på att du vill banna @${username}?";
  ...
  static String m11(min) => "Du måste välja åtminstone ${min} kategorier.";

  static String m12(min) => "Du måste välja åtminstone ${min} kategori.";

  static String m13(max) => "Välj upp till ${max} kategorier";

  static String m14(maxLength) =>
      "Reglerna får inte vara längre än ${maxLength} tecken.";

  static String m15(takenName) => "Gemenskapsnamnet '${takenName}' är upptaget";

  static String m16(maxLength) =>
      "Titeln får inte vara längre än ${maxLength} tecken.";

  static String m17(categoryName) => "Trendiga i ${categoryName}";

  static String m18(hashtag) =>
      "Du kommer bli den första som använder #${hashtag}";

  static String m19(platform) => "Kör på ${platform}";

  static String m20(currentUserLanguage) => "Språk (${currentUserLanguage})";

  static String m21(limit) => "Filen är för stor (gräns: ${limit} MB)";
  ...
  static String m31(commentsCount) => "Visa alla ${commentsCount} kommentarer";
  ...
  static String m34(name) => "${name} har inte delat något ännu.";

  static String m35(postCreatorUsername) => "@${postCreatorUsername}s kretsar";
  ...
  static String m39(username) =>
      "Är du säker på att du vill blockera @${username}?";

  static String m40(userName) => "Bekräfta ${userName}s kontaktförfrågan";

  static String m41(userName) => "Lägg till ${userName} som kontakt";

  static String m42(userName) => "Ta bort ${userName} som kontakt";

  static String m43(limit) => "Bilden är för stor (gräns: ${limit} MB)";

  static String m44(username) => "Användarnamnet @${username} är upptaget";

  static String m45(searchQuery) =>
      "Ingen emoji hittades som matchar '${searchQuery}'.";

  static String m46(searchQuery) => "Inga listor hittades för '${searchQuery}'";

  static String m47(prettyUsersCount) => "${prettyUsersCount} konton";

  static String m48(prettyUsersCount) => "${prettyUsersCount} Konton";

  static String m49(groupName) => "Visa alla ${groupName}";

  static String m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Hej, jag vill bjuda in dig till Kootumb.\n\nFör Apple, ladda först ner TestFlight-appen från iTunes (${testFlightLink}) och ladda sedan ner Kootumb-appen (${iosLink}).\n\nFör Android, ladda ner Kootumb-appen från Play Store (${androidLink}).\n\nEfter det så klistrar du in den här personliga inbjudningslänken i 'Registrera dig'-formuläret i Kootumb-appen: ${inviteLink}";

  static String m51(username) => "Gick med under användarnamnet @${username}";

  static String m52(email) => "Väntande, inbjudan skickad till ${email}";

  static String m53(maxLength) =>
      "Listans namn får inte vara längre än ${maxLength} tecken.";

  static String m54(maxLength) =>
      "Bion kan inte vara längre än ${maxLength} tecken.";

  static String m55(maxLength) =>
      "En plats kan inte vara längre än ${maxLength} tecken.";

  static String m56(age) => "På Kootumb sedan ${age}";

  static String m57(takenConnectionsCircleName) =>
      "Kretsnamnet '${takenConnectionsCircleName}' är upptaget";

  static String m58(listName) => "Listnamnet '${listName}' är upptaget";

  static String m59(searchQuery) =>
      "Inga resultat hittades för '${searchQuery}'.";

  static String m60(resourcePluralName) =>
      "Inga ${resourcePluralName} hittades.";

  static String m61(resourcePluralName) => "Sök ${resourcePluralName} ...";

  static String m62(searchQuery) =>
      "Inga gemenskaper hittades för '${searchQuery}'.";

  static String m63(searchQuery) =>
      "Inga hashtaggar hittades för '${searchQuery}'.";
  ...
  static String m66(searchQuery) => "Söker efter '${searchQuery}'";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Använd länken från Join Kootumb-knappen i din inbjudan."),
        ...
        "drawer__main_title":
            MessageLookupByLibrary.simpleMessage("Mitt Kootumb"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Kootumbs riktlinjer"),
        ...
        "drawer__useful_links_guidelines_handbook":
            MessageLookupByLibrary.simpleMessage("Kootumbs handbok"),
        ...
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "En plats för diskussioner om allt om Kootumb"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Stöd Kootumb"),
        ...
        "moderation__moderated_object_verified_by_staff":
            MessageLookupByLibrary.simpleMessage(
                "Verifierad av Kootumbs personal"),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "Du kan inte använda Kootumb förrän du har godkänt riktlinjerna."),
