...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(username) =>
      "Você tem certeza de que deseja banir @${username}?";
  ...
  static String m11(min) => "Você deve escolher pelo menos ${min} categorias.";

  static String m12(min) => "Você deve escolher pelo menos ${min} categoria.";

  static String m13(max) => "Escolha até ${max} categorias";
  ...
  static String m17(categoryName) => "Populares em ${categoryName}";

  static String m18(hashtag) => "Você será o primeiro a usar #${hashtag}";

  static String m19(platform) => "Executando em ${platform}";

  static String m20(currentUserLanguage) => "Idioma (${currentUserLanguage})";

  static String m21(limit) => "Arquivo muito grande (limite: ${limit} MB)";
  ...
  static String m27(communityName) =>
      "Houve uma nova postagem em c/${communityName}.";
  ...
  static String m34(name) => "${name} ainda não compartilhou nada.";

  static String m35(postCreatorUsername) =>
      "círculos de @${postCreatorUsername}";
  ...
  static String m38(prettyUsersCount) => "${prettyUsersCount} pessoas";

  static String m39(username) =>
      "Tem certeza de que deseja bloquear @${username}?";

  static String m40(userName) => "Confirmar a conexão com ${userName}";

  static String m41(userName) => "Conectar-se com ${userName}";

  static String m42(userName) => "Desconectar-se de ${userName}";

  static String m43(limit) => "Imagem muito grande (limite: ${limit} MB)";
  ...
  static String m47(prettyUsersCount) => "${prettyUsersCount} contas";

  static String m48(prettyUsersCount) => "${prettyUsersCount} Contas";

  static String m49(groupName) => "Ver ${groupName}";

  static String m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Ei, eu gostaria de convidar você para a rede social Kootumb.\n\nSe tiver iOS, primeiro, baixe o aplicativo TestFlight na App Store (${testFlightLink}) e, em seguida, baixe o aplicativo Kootumb (${iosLink})\n\nSe tiver Android, faça o download na Play Store (${androidLink}).\n\nDepois, cole este link de convite personalizado no formulário 'Cadastrar-se' no aplicativo Kootumb: ${inviteLink}";

  static String m51(username) => "Entrou com o nome de usuário @${username}";

  static String m52(email) => "Pendente, convite enviado para o email ${email}";
  ...
  static String m56(age) => "Na Kootumb desde ${age}";

  static String m57(takenConnectionsCircleName) =>
      "O nome de círculo '${takenConnectionsCircleName}' já está em uso";

  static String m58(listName) =>
      "O nome de lista '${listName}' já está sendo usado";

  static String m59(searchQuery) => "Nada encontrado para '${searchQuery}'.";

  static String m60(resourcePluralName) => "Sem ${resourcePluralName}.";

  static String m61(resourcePluralName) =>
      "Pesquisar ${resourcePluralName} ...";
  ...
  static String m64(searchQuery) => "Nenhum resultado para '${searchQuery}'.";

  static String m65(searchQuery) =>
      "Nenhum usuário encontrado para '${searchQuery}'.";

  static String m66(searchQuery) => "Procurando por '${searchQuery}'";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "drawer__main_title": MessageLookupByLibrary.simpleMessage("Kootumb"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Diretrizes da Kootumb"),
        ...
        "drawer__useful_links_guidelines_handbook":
            MessageLookupByLibrary.simpleMessage("Manual da Kootumb"),
        ...
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "Um lugar para discutir tudo sobre a Kootumb"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Apoie a Kootumb"),
        ...
        "moderation__moderated_object_verified_by_staff":
            MessageLookupByLibrary.simpleMessage(
                "Verificado pela equipe da Kootumb"),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "Você não pode usar a Kootumb até aceitar as diretrizes."),
