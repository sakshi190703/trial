...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(username) => "Sei sicuro di voler bloccare @${username}?";
  ...
  static String m11(min) => "Devi scegliere almeno ${min} categoria/e.";

  static String m12(min) => "Devi scegliere almeno ${min} categoria/e.";

  static String m13(max) => "Scegli fino a ${max} categorie";
  ...
  static String m17(categoryName) => "Di tendenza in ${categoryName}";

  static String m18(hashtag) => "Sarai il primo a usare #${hashtag}";

  static String m19(platform) => "Gira su ${platform}";

  static String m20(currentUserLanguage) => "Lingua (${currentUserLanguage})";

  static String m21(limit) => "File troppo grande (limite: ${limit} MB)";
  ...
  static String m27(communityName) =>
      "C'è un nuovo post in c/${communityName}.";
  ...
  static String m31(commentsCount) =>
      "Mostra tutti i ${commentsCount} commenti";
  ...
  static String m34(name) => "${name} non ha ancora condiviso niente.";

  static String m35(postCreatorUsername) =>
      "le cerchie di @${postCreatorUsername}";
  ...
  static String m38(prettyUsersCount) => "${prettyUsersCount} persone";

  static String m39(username) => "Sei sicuro di voler bloccare @${username}?";

  static String m40(userName) => "Conferma la connessione con ${userName}";

  static String m41(userName) => "Connettiti con ${userName}";

  static String m42(userName) => "Disconnetti da ${userName}";

  static String m43(limit) => "Immagine troppo grande (limite: ${limit} MB)";

  static String m44(username) => "Il nome utente @${username} è stato preso";

  static String m45(searchQuery) =>
      "Nessun emoji trovato corrispondente a '${searchQuery}'.";

  static String m46(searchQuery) =>
      "Nessuna lista trovata per '${searchQuery}'";

  static String m47(prettyUsersCount) => "${prettyUsersCount} account";

  static String m48(prettyUsersCount) => "${prettyUsersCount} Profili";

  static String m49(groupName) => "Vedi tutti/e ${groupName}";

  static String m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Ehi, vorrei invitarti su Kootumb.\n\nPer Apple, prima scarica l'app TestFlight su iTunes (${testFlightLink}) e poi scarica l'app Kootumb (${iosLink})\n\nPer Android, scaricala dal Play store (${androidLink}).\n\nIn seguito, incolla questo link di invito personalizzato nel modulo 'Iscriviti' nell'App Kootumb: ${inviteLink}";

  static String m51(username) => "Iscritto con nome utente @${username}";

  static String m52(email) => "In attesa, invia email di invito a ${email}";
  ...
  static String m56(age) => "Su Kootumb dal ${age}";
  ...
  static String m59(searchQuery) => "Nessun risultato per '${searchQuery}'.";

  static String m60(resourcePluralName) =>
      "Impossibile trovare ${resourcePluralName}.";

  static String m61(resourcePluralName) => "Cerca ${resourcePluralName}...";

  static String m62(searchQuery) =>
      "Nessuna Comunità trovata per '${searchQuery}'.";

  static String m63(searchQuery) =>
      "Nessun hashtag trovato per '${searchQuery}'.";

  static String m64(searchQuery) => "Nessun risultato per '${searchQuery}'.";

  static String m65(searchQuery) =>
      "Nessun Utente trovato per '${searchQuery}'.";

  static String m66(searchQuery) => "Ricerca di '${searchQuery}'";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Usa il link dal pulsante Join Kootumb nella tua email di invito."),
        ...
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Sostieni Kootumb"),
        ...
        "moderation__moderated_object_verified_by_staff":
            MessageLookupByLibrary.simpleMessage(
                "Verificato dagli addetti Kootumb"),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "Non puoi usare Kootumb finché non accetti le linee guida."),
