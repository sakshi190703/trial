...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(minLength, maxLength) => "(${minLength}-${maxLength} tegn)";
  ...
  static String m7(username) =>
      "Er du sikker på, at du vil blokere @${username}?";
  ...
  static String m11(min) => "Du skal vælge mindst ${min} kategorier!";

  static String m12(min) => "Du skal vælge mindst ${min} kategori!";

  static String m13(max) => "Vælg op til ${max} kategorier";

  static String m14(maxLength) =>
      "Regler kan ikke være længere end ${maxLength} tegn.";

  static String m15(takenName) => "Fællesskabs navn '${takenName}' er i brug";

  static String m16(maxLength) =>
      "Titlen kan ikke være længere end ${maxLength} tegn.";

  static String m17(categoryName) => "Populær i ${categoryName}";

  static String m18(hashtag) => "Du er den første der bruger #${hashtag}";

  static String m19(platform) => "Kører på ${platform}";

  static String m20(currentUserLanguage) => "Sprog (${currentUserLanguage})";

  static String m21(limit) => "Fil for stor (limit: ${limit} MB)";
  ...
  static String m27(communityName) =>
      "Der er et nyt indlæg i c/${communityName}.";
  ...
  static String m31(commentsCount) => "Se alle ${commentsCount} kommentarer";
  ...
  static String m34(name) => "${name} har ikke delt noget endnu.";

  static String m35(postCreatorUsername) => "@${postCreatorUsername}'s cirkler";
  ...
  static String m38(prettyUsersCount) => "${prettyUsersCount} personer";

  static String m39(username) =>
      "Er du sikker på, at du vil blokere @${username}?";

  static String m40(userName) => "Bekræft kontakt med ${userName}";

  static String m41(userName) => "Forbind med ${userName}";

  static String m42(userName) => "Fjern forbindelse med ${userName}";

  static String m43(limit) => "Billede for stort (limit: ${limit} MB)";

  static String m44(username) => "Brugernavnet @${username} er allerede taget";

  static String m45(searchQuery) =>
      "Intet passende emoji fundet '${searchQuery}'.";

  static String m46(searchQuery) => "Ingen liste fundet for '${searchQuery}'";

  static String m47(prettyUsersCount) => "${prettyUsersCount} konti";

  static String m48(prettyUsersCount) => "${prettyUsersCount} Konti";

  static String m49(groupName) => "Se alle ${groupName}";

  static String m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Hej, jeg vil gerne invitere dig til Kootumb.\n\nFor Apple skal du først downloade TestFlight appen fra iTunes (${testFlightLink}) og så downloade Kootumb appen (${iosLink})\n\nFor Android skal du downloade den fra Play storen (${androidLink}).\n\nNæst kopier denne personaliserede invitations link i 'Sign up' formen i Kootumb Appen: ${inviteLink}";

  static String m51(username) => "Blevet medlem med brugernavn @${username}";

  static String m52(email) => "Verserende, invitationsemail sendt til ${email}";
  ...
  static String m55(maxLength) =>
      "Bopæl kan ikke være længere end ${maxLength} tegn.";

  static String m56(age) => "På Kootumb siden ${age}";

  static String m57(takenConnectionsCircleName) =>
      "Kredsnavn '${takenConnectionsCircleName}' er allerede taget";

  static String m58(listName) => "Listenavn '${listName}' er allerede taget";

  static String m59(searchQuery) =>
      "Ingen overensstemmelse med '${searchQuery}'.";

  static String m60(resourcePluralName) =>
      "Ingen ${resourcePluralName} fundet.";

  static String m61(resourcePluralName) => "Søg ${resourcePluralName} ...";

  static String m62(searchQuery) =>
      "Ingen fællesskaber fundet for '${searchQuery}'.";

  static String m63(searchQuery) =>
      "Ingen hashtags fundet for '${searchQuery}'.";

  static String m64(searchQuery) => "Ingen resultater for '${searchQuery}'.";

  static String m65(searchQuery) =>
      "Ingen brugere fundet for '${searchQuery}'.";

  static String m66(searchQuery) => "Søger efter '${searchQuery}'";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Benyt linket fra tilmeld Kootumb knappen i din email invitation."),
        ...
        "drawer__main_title":
            MessageLookupByLibrary.simpleMessage("Mit Kootumb"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Kootumb retningslinjer"),
        ...
        "drawer__useful_links_guidelines_handbook":
            MessageLookupByLibrary.simpleMessage("Kootumb håndbog"),
        ...
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "Stedet hvor alt om Kootumb diskuteres"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Støt Kootumb"),
        ...
        "moderation__moderated_object_verified_by_staff":
            MessageLookupByLibrary.simpleMessage(
                "Gennemset af Kootumb personale"),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "Du kan ikke bruge Kootumb før du accepterer retningslinjerne."),
