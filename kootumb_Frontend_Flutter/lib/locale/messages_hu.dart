...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(username) => "Biztosan le szeretnéd tiltani @${username}-t?";
  ...
  static String m10(maxLength) =>
      "A név nem lehet ${maxLength} karakternél hosszabb.";

  static String m11(min) => "Legalább ${min} kategóriát kell kiválasztanod.";

  static String m12(min) => "Legalább ${min} kategóriát kell kiválasztanod.";

  static String m13(max) => "Válassz ki legfeljebb ${max} kategóriát";

  static String m14(maxLength) =>
      "A szabályzat nem lehet ${maxLength} karakternél hosszabb.";

  static String m15(takenName) => "A(z) ${takenName} név már foglalt";

  static String m16(maxLength) =>
      "A cím nem lehet ${maxLength} karakternél hosszabb.";

  static String m17(categoryName) =>
      "Felkapottak a(z) ${categoryName} kategóriában";

  static String m18(hashtag) => "You'll be the first to use #${hashtag}";

  static String m19(platform) => "Platform: ${platform}";

  static String m20(currentUserLanguage) => "Nyelv (${currentUserLanguage})";

  static String m21(limit) => "A fájl túl nagy (korlát: ${limit} MB)";
  ...
  static String m34(name) => "${name} még nem osztott meg semmit.";

  static String m35(postCreatorUsername) => "@${postCreatorUsername} köreiben";
  ...
  static String m38(prettyUsersCount) => "${prettyUsersCount} ember";

  static String m39(username) =>
      "Biztosan le szeretnéd tiltani @${username}-t?";

  static String m40(userName) => "Kapcsolat megerősítése vele: ${userName}";

  static String m41(userName) => "Kapcsolódás vele: ${userName}";

  static String m42(userName) => "Kapcsolat törlése vele: ${userName}";

  static String m43(limit) => "A kép túl nagy (korlát: ${limit} MB)";

  static String m44(username) => "A(z) @${username} felhasználónév foglalt";
  ...
  static String m47(prettyUsersCount) => "${prettyUsersCount} fiók";

  static String m48(prettyUsersCount) => "${prettyUsersCount} fiók";

  static String m49(groupName) => "Összes ${groupName} megtekintése";

  static String m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Szia! Meg szeretnélek hívni az Kootumb közösségi hálózatra.\n\niOS esetén először töltsd le a TestFlight alkalmazást az iTunes-ról (${testFlightLink}), majd töltsd le az Kootumb alkalmazást (${iosLink}).\n\nAndroid esetén töltsd le a Play áruházból (${androidLink}).\n\nMiután sikeresen letöltötted az alkalmazást, illeszd be ezt a személyre szabott meghívó linket az Kootumb alkalmazás regisztrációs űrlapjába: ${inviteLink}";

  static String m51(username) =>
      "Regisztrált a(z) @${username} felhasználónévvel";
  ...
  static String m58(listName) => "A(z) '${listName}' listanév már foglalt";

  static String m59(searchQuery) =>
      "Nincs találat a(z) \"${searchQuery}\" keresésre.";

  static String m60(resourcePluralName) =>
      "Nem találhatóak ${resourcePluralName}.";

  static String m61(resourcePluralName) => "${resourcePluralName} keresése...";
  ...
  static String m66(searchQuery) => "\"${searchQuery}\" keresése";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Használd a \"Join Kongo\" gomb linkjét a meghívó e-mail-edből."),
        ...
        "drawer__main_title":
            MessageLookupByLibrary.simpleMessage("Saját Kootumb"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Kootumb irányelvek"),
        ...
        "drawer__useful_links_guidelines_handbook":
            MessageLookupByLibrary.simpleMessage("Kootumb kézikönyv"),
        ...
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Az Kootumb támogatása"),
        ...
        "moderation__moderated_object_verified_by_staff":
            MessageLookupByLibrary.simpleMessage(
                "Az Kootumb csapata által ellenőrizve"),
