...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(username) => "Are you sure you want to ban @${username}?";
  ...
  static String m11(min) => "You must pick at least ${min} categories.";

  static String m12(min) => "You must pick at least ${min} category.";

  static String m13(max) => "Pick up to ${max} categories";

  static String m14(maxLength) =>
      "Rules can't be longer than ${maxLength} characters.";

  static String m15(takenName) => "Community name '${takenName}' is taken";

  static String m16(maxLength) =>
      "Title can't be longer than ${maxLength} characters.";

  static String m17(categoryName) => "Trending in ${categoryName}";

  static String m18(hashtag) => "You'll be the first to use #${hashtag}";

  static String m19(platform) => "Running on ${platform}";

  static String m20(currentUserLanguage) => "Language (${currentUserLanguage})";

  static String m67(limit) => "Text is too long (limit: ${limit} characters)";

  static String m21(limit) => "File too large (limit: ${limit} MB)";
  ...
  static String m31(commentsCount) => "View all ${commentsCount} comments";
  ...
  static String m34(name) => "${name} has not shared anything yet.";

  static String m35(postCreatorUsername) => "@${postCreatorUsername}'s circles";

  static String m36(description) =>
      "Failed to preview link with website error: ${description}";

  static String m68(link) => "Invalid link: ${link}";

  static String m37(maxLength) =>
      "Circle name must be no longer than ${maxLength} characters.";

  static String m38(prettyUsersCount) => "${prettyUsersCount} people";

  static String m39(username) => "Are you sure you want to block @${username}?";

  static String m40(userName) => "Confirm connection with ${userName}";

  static String m41(userName) => "Connect with ${userName}";

  static String m42(userName) => "Disconnect from ${userName}";

  static String m43(limit) => "Image too large (limit: ${limit} MB)";

  static String m44(username) => "Username @${username} is taken";

  static String m45(searchQuery) => "No emoji found matching '${searchQuery}'.";

  static String m46(searchQuery) => "No list found for '${searchQuery}'";

  static String m47(prettyUsersCount) => "${prettyUsersCount} accounts";

  static String m48(prettyUsersCount) => "${prettyUsersCount} Accounts";

  static String m49(groupName) => "See all ${groupName}";

  static String m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Hey, I'd like to invite you to Kootumb.\n\nFor Apple, first, download the TestFlight app on iTunes (${testFlightLink}) and then download the Kootumb app (${iosLink})\n\nFor Android, download it from the Play store (${androidLink}).\n\nSecond, paste this personalised invite link in the 'Sign up' form in the Kootumb App: ${inviteLink}";

  static String m51(username) => "Joined with username @${username}";

  static String m52(email) => "Pending, invite email sent to ${email}";

  static String m53(maxLength) =>
      "List name must be no longer than ${maxLength} characters.";

  static String m54(maxLength) =>
      "Bio can't be longer than ${maxLength} characters.";

  static String m55(maxLength) =>
      "Location can't be longer than ${maxLength} characters.";

  static String m56(age) => "On Kootumb since ${age}";

  static String m57(takenConnectionsCircleName) =>
      "Circle name '${takenConnectionsCircleName}' is taken";

  static String m58(listName) => "List name '${listName}' is taken";

  static String m59(searchQuery) => "No match for '${searchQuery}'.";

  static String m60(resourcePluralName) => "No ${resourcePluralName} found.";

  static String m61(resourcePluralName) => "Search ${resourcePluralName} ...";

  static String m62(searchQuery) =>
      "No communities found for '${searchQuery}'.";

  static String m63(searchQuery) => "No hashtags found for '${searchQuery}'.";

  static String m64(searchQuery) => "No results for '${searchQuery}'.";

  static String m65(searchQuery) => "No users found for '${searchQuery}'.";

  static String m66(searchQuery) => "Searching for '${searchQuery}'";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Use the link from the Join Kongo button in your invitation email."),
        ...
        "auth__create_acc__your_subscribed":
            MessageLookupByLibrary.simpleMessage("You're {0} on the waitlist."),
        ...
        "drawer__main_title":
            MessageLookupByLibrary.simpleMessage("my kootumb"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Kootumb guidelines"),
        ...
        "drawer__useful_links_guidelines_handbook":
            MessageLookupByLibrary.simpleMessage("Kootumb user guide"),
        ...
        "drawer__useful_links_guidelines_roadmap":
            MessageLookupByLibrary.simpleMessage("The Kootumb roadmap"),
        ...
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "A place to discuss everything about Kootumb"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Support Kootumb"),
        ...
        "moderation__moderated_object_verified_by_staff":
            MessageLookupByLibrary.simpleMessage("Verified by Kootumb staff"),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "You can't use Kootumb until you accept the guidelines."),
