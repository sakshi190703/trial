...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m10(maxLength) =>
      "İsim ${maxLength} karakterden daha uzun olamaz.";

  static String m11(min) => "En az ${min} kategori seçmelisin.";

  static String m12(min) => "En az ${min} kategori seçmelisin.";

  static String m13(max) => "${max} kategoriye kadar seç";

  static String m14(maxLength) =>
      "Kurallar bölümü ${maxLength} karakterden daha uzun olamaz.";

  static String m15(takenName) => "'${takenName}' olarak topluluk adı alınmış";

  static String m16(maxLength) =>
      "Başlık ${maxLength} karakterden daha uzun olamaz.";

  static String m17(categoryName) => "${categoryName} kategorisindeki trend";

  static String m18(hashtag) => "You'll be the first to use #${hashtag}";

  static String m19(platform) => "${platform} 'da yayınlanıyor";

  static String m20(currentUserLanguage) => "Dil (${currentUserLanguage})";

  static String m21(limit) => "Dosya çok büyük (limit: ${limit} MB)";
  ...
  static String m31(commentsCount) =>
      "${commentsCount} yorumun tümünü görüntüle";
  ...
  static String m34(name) => "${name} henüz bir şey paylaşmadı.";
  ...
  static String m38(prettyUsersCount) => "${prettyUsersCount} kişi";

  static String m39(username) =>
      "@${username} adlı kullanıcıyı engellemek istediğinizden emin misiniz?";

  static String m40(userName) => "${userName} ile bağlantıyı onaylayın";

  static String m41(userName) => "${userName} ile bağlan";

  static String m42(userName) => "${userName} ile bağlantını kes";

  static String m43(limit) => "Resim çok büyük (limit: ${limit} MB)";

  static String m44(username) => "Kullanıcı adı @${username} alındı";

  static String m45(searchQuery) =>
      "'${searchQuery}' ile eşleşen hiçbir emoji bulunamadı.";

  static String m46(searchQuery) =>
      "'${searchQuery}' için hiç bir liste bulunamadı";

  static String m47(prettyUsersCount) => "${prettyUsersCount} hesap";

  static String m48(prettyUsersCount) => "${prettyUsersCount} Hesap";

  static String m49(groupName) => "${groupName} Tümünü gör";

  static String m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Hey, seni Kootumb'ya davet etmek istiyorum.\n\nApple için, önce TestFlight (${testFlightLink}) uygulamasını iTunes'a indirin ve ardından Kootumb uygulamasını (${iosLink}) indirin\n\nAndroid için Play Store'dan indirin (${androidLink}).\n\nİkinci olarak, bu kişiselleştirilmiş davet bağlantısını Kootumb Uygulamasındaki 'Kayıt ol' formuna yapıştırın: ${inviteLink}";

  static String m51(username) => "@${username} kullanıcı adı ile katıldı";
  ...
  static String m58(listName) => "Liste adı '${listName}' olarak alındı";

  static String m59(searchQuery) =>
      "'${searchQuery}' ile ilgili bir eşleşme yok.";

  static String m60(resourcePluralName) =>
      "${resourcePluralName} için hiç bir bulunamadı.";

  static String m61(resourcePluralName) => "${resourcePluralName} Aranıyor...";
  ...
  static String m66(searchQuery) => "'${searchQuery}' için arama yapılıyor";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Davet e-postanızdaki Kongo'a Katıl düğmesini tıklayın."),
        ...
        "drawer__main_title":
            MessageLookupByLibrary.simpleMessage("Benim Kootumb'm"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Kootumb'nın ilkeleri"),
        ...
        "drawer__useful_links_guidelines_handbook":
            MessageLookupByLibrary.simpleMessage("Kootumb el kitabı"),
        ...
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "Kootumb hakkında her şeyi tartışacağınız bir yer"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Kootumb Destek"),
        ...
        "moderation__moderated_object_verified_by_staff":
            MessageLookupByLibrary.simpleMessage(
                "Kootumb çalışanı tarafından doğrulandı"),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "Kuralları kabul edene kadar Kootumb'yı kullanamazsınız."),
