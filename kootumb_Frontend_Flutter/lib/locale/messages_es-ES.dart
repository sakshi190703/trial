...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(username) => "¿Seguro que quieres banear a @${username}?";
  ...
  static String m11(min) => "Debes elegir al menos ${min} categorías.";

  static String m12(min) => "Debes elegir al menos ${min} categoría.";

  static String m13(max) => "Escoge hasta ${max} categorías";

  static String m14(maxLength) =>
      "Las reglas no pueden tener más de ${maxLength} caracteres.";

  static String m15(takenName) => "El nombre '${takenName}' esta tomado";

  static String m16(maxLength) =>
      "El título no puede ser más largo que ${maxLength} caracteres.";

  static String m17(categoryName) => "Trending en ${categoryName}";

  static String m18(hashtag) => "Serás el primero en usar #${hashtag}";

  static String m19(platform) => "Disponible en ${platform}";

  static String m20(currentUserLanguage) => "Idioma (${currentUserLanguage})";

  static String m21(limit) => "Archivo demasiado grande (límite: ${limit} MB)";

  static String m22(resourceCount, resourceName) =>
      "Ver todos los ${resourceCount} ${resourceName}";

  static String m23(postCommentText) =>
      "[name] [username] también comentó: ${postCommentText}";

  static String m24(postCommentText) =>
      "[name] [username] comentó en tu post: ${postCommentText}";

  static String m25(postCommentText) =>
      "[name] [username] también respondió: ${postCommentText}";

  static String m26(postCommentText) =>
      "[name] [username] respondió: ${postCommentText}";

  static String m27(communityName) =>
      "Hubo una nueva publicación en c/${communityName}.";

  static String m28(postCommentText) =>
      "[name] [username] te mencionó en un comentario: ${postCommentText}";

  static String m29(communityName) =>
      "[name] [username] te ha invitado a unirte a la comunidad /c/${communityName}.";

  static String m30(maxLength) =>
      "Un comentario no puede ser más largo que ${maxLength} caracteres.";

  static String m31(commentsCount) => "Ver los ${commentsCount} comentarios";

  static String m32(maxHashtags, maxCharacters) =>
      "Por favor, añade un máximo de ${maxHashtags} hashtags y manténgalos con menos de ${maxCharacters} caracteres.";

  static String m33(circlesSearchQuery) =>
      "'No se han encontrado círculos que coincidan con '${circlesSearchQuery}'.";

  static String m34(name) => "${name} aún no ha compartido nada.";

  static String m35(postCreatorUsername) =>
      "los círculos de @${postCreatorUsername}'s";

  static String m36(description) =>
      "Error al previsualizar el enlace con error del sitio web: ${description}";

  static String m37(maxLength) =>
      "El nombre del círculo no debe tener más de ${maxLength} caracteres.";

  static String m38(prettyUsersCount) => "${prettyUsersCount} gente";

  static String m39(username) => "¿Seguro que quieres banear a @${username}?";

  static String m40(userName) => "Confirmar conexión con ${userName}";

  static String m41(userName) => "Conectar con ${userName}";

  static String m42(userName) => "Desconectarse de ${userName}";

  static String m43(limit) => "Imagen demasiado grande (límite: ${limit} MB)";

  static String m44(username) => "El nombre de usuario @${username} ya existe";

  static String m45(searchQuery) =>
      "No se encontró un Emoji similar a '${searchQuery}'.";

  static String m46(searchQuery) => "No se encontró lista con '${searchQuery}'";

  static String m47(prettyUsersCount) => "${prettyUsersCount} cuentas";

  static String m48(prettyUsersCount) => "${prettyUsersCount} Cuentas";

  static String m49(groupName) => "Ver ${groupName}";

  static String m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Hola, me gustaría invitarte a Kootumb.\n\nPara Apple, primero descarga la aplicación TestFlight en iTunes (${testFlightLink}) y luego descarga la aplicación Kootumb (${iosLink})\n\nPara Android, descargalo desde Play store (${androidLink}).\n\nSegundo, pega este enlace de invitación personalizado en el formulario de 'Registro' en la App de Kootumb: ${inviteLink}";

  static String m51(username) =>
      "Se unió con el nombre de usuario @${username}";

  static String m52(email) =>
      "Pendiente, email de invitación enviado a ${email}";

  static String m53(maxLength) =>
      "El nombre de la lista no debe tener más de ${maxLength} caracteres.";

  static String m54(maxLength) =>
      "La biografía no puede contener más de ${maxLength} caracteres.";

  static String m55(maxLength) =>
      "La ubicación no puede contener más de ${maxLength} caracteres.";

  static String m56(age) => "En Kootumb desde ${age}";

  static String m57(takenConnectionsCircleName) =>
      "El nombre de lista '${takenConnectionsCircleName}' esta tomado";

  static String m58(listName) => "El nombre de lista '${listName}' esta tomado";

  static String m59(searchQuery) => "Sin resultados para '${searchQuery}'.";

  static String m60(resourcePluralName) =>
      "No se encontró ningun ${resourcePluralName}.";

  static String m61(resourcePluralName) => "Buscar ${resourcePluralName}...";

  static String m62(searchQuery) =>
      "No se encontraron comunidades para '${searchQuery}'.";

  static String m63(searchQuery) =>
      "No se encontraron hashtags para '${searchQuery}'.";

  static String m64(searchQuery) => "Sin resultados para \"${searchQuery}\".";

  static String m65(searchQuery) =>
      "No se encontraron usuarios para '${searchQuery}'.";

  static String m66(searchQuery) => "Buscando '${searchQuery}'";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "application_settings__link_previews_autoplay_always":
            MessageLookupByLibrary.simpleMessage("Siempre"),
        ...
        "application_settings__videos_autoplay":
            MessageLookupByLibrary.simpleMessage("Reproducción automática"),
        ...
        "application_settings__videos_sound":
            MessageLookupByLibrary.simpleMessage("Sonido"),
        ...
        "application_settings__videos_sound_enabled":
            MessageLookupByLibrary.simpleMessage("Activado"),
        ...
        "auth__create_acc__link_invalid_error":
            MessageLookupByLibrary.simpleMessage("El link es inválido."),
        ...
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Utiliza el link en tu correo de invitación a Kootumb."),
        ...
        "auth__create_acc__suggested_communities":
            MessageLookupByLibrary.simpleMessage(
                "🥳 Comienza uniéndote a las siguientes comunidades."),
        ...
        "auth__create_acc__validating_token":
            MessageLookupByLibrary.simpleMessage("Validando el token..."),
        ...
        "bottom_sheets__confirm_action_are_you_sure":
            MessageLookupByLibrary.simpleMessage("Estas segur@?"),
        ...
        "community__details_favorite":
            MessageLookupByLibrary.simpleMessage("En favoritos"),
        "community__exclude_joined_communities":
            MessageLookupByLibrary.simpleMessage(
                "Excluir comunidades parte de"),
        "community__exclude_joined_communities_desc":
            MessageLookupByLibrary.simpleMessage(
                "No mostrar posts de comunidades de las que soy miembro"),
        "community__excluded_communities":
            MessageLookupByLibrary.simpleMessage("comunidades excluidas"),
        "community__excluded_community":
            MessageLookupByLibrary.simpleMessage("comunidad excluida"),
        ...
        "community__top_posts_excluded_communities_desc":
            MessageLookupByLibrary.simpleMessage(
                "Administrar comunidades excluidas de la línea de tiempo explore"),
        "community__top_posts_settings":
            MessageLookupByLibrary.simpleMessage("Ajustes de explore"),
        ...
        "drawer__developer_settings": MessageLookupByLibrary.simpleMessage(
        ...
        "drawer__main_title":
            MessageLookupByLibrary.simpleMessage("Mi Kootumb"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Reglas de Kootumb"),
        ...
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "Un lugar para discutir todo sobre Kootumb"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Contribuir a Kootumb"),
        ...
        "image_picker__from_camera":
            MessageLookupByLibrary.simpleMessage("De la cámara"),
        "image_picker__from_gallery":
            MessageLookupByLibrary.simpleMessage("De la galería"),
        ...
        "moderation__moderated_object_verified_by_staff":
            MessageLookupByLibrary.simpleMessage(
                "Verificado por el equipo de Kootumb"),
        ...
        "moderation__you_have_reported_hashtag_text":
            MessageLookupByLibrary.simpleMessage("Has reportado este Hashtag"),
        ...
        "notifications__comment_user_mention_desc":
            MessageLookupByLibrary.simpleMessage(
                "Ser notificado cuando alguien te mencione en uno de sus comentarios"),
        "notifications__comment_user_mention_title":
            MessageLookupByLibrary.simpleMessage("Menciónes en comentarios"),
        ...
        "notifications__community_new_post_desc":
            MessageLookupByLibrary.simpleMessage(
                "Se notificado cuando haya una nueva publicación en una comunidad en la que hayas activado las notificaciones de publicación"),
        "notifications__community_new_post_tile": m27,
        "notifications__community_new_post_title":
            MessageLookupByLibrary.simpleMessage("Nuevo post de comunidad"),
        ...
        "notifications__mentioned_in_post_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] te mencionó en un post."),
        ...
        "notifications__post_user_mention_desc":
            MessageLookupByLibrary.simpleMessage(
                "Ser notificado cuando alguien te mencione en uno de sus mensajes"),
        "notifications__post_user_mention_title":
            MessageLookupByLibrary.simpleMessage("Menciónes en posts"),
        ...
        "notifications__tab_requests":
            MessageLookupByLibrary.simpleMessage("Solicitudes"),
        "notifications__user_community_invite_tile": m29,
        "notifications__user_new_post_desc": MessageLookupByLibrary.simpleMessage(
            "Se notificado cuando haya una nueva publicación de un usuario en el que hayas activado las notificaciones"),
        "notifications__user_new_post_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] publicó algo."),
        "notifications__user_new_post_title":
            MessageLookupByLibrary.simpleMessage(
                "Nueva publicación de usuario"),
        "permissions_service__camera_permission_denied":
            MessageLookupByLibrary.simpleMessage(
                "Necesitamos el permiso de la cámara para permitirte tomar fotos y grabar vídeos, por favor concédalo en tus ajustes."),
        "permissions_service__storage_permission_denied":
            MessageLookupByLibrary.simpleMessage(
                "Necesitamos el permiso de almacenamiento para permitirte elegir elementos multimedia, por favor concédalo en tus ajustes."),
        ...
        "post__actions_delete_comment_description":
            MessageLookupByLibrary.simpleMessage(
                "Este comentario, así como sus respuestas y reacciones serán eliminadas permanentemente."),
        "post__actions_delete_description": MessageLookupByLibrary.simpleMessage(
            "Esta publicación, así como sus comentarios y reacciones se eliminarán permanentemente."),
        ...
        "post__close_create_post_label":
            MessageLookupByLibrary.simpleMessage("Cerrar crear nuevo post"),
        ...
        "post__exclude_post_community": MessageLookupByLibrary.simpleMessage(
            "No mostrar publicaciones de esta comunidad"),
        ...
        "post__load_more":
            MessageLookupByLibrary.simpleMessage("Cargar más publicaciones"),
        "post__my_circles":
            MessageLookupByLibrary.simpleMessage("Mis círculos"),
        ...
        "post__undo_exclude_post_community":
            MessageLookupByLibrary.simpleMessage(
                "Mostrar publicaciones de esta comunidad"),
        ...
        "post_body_link_preview__empty": MessageLookupByLibrary.simpleMessage(
            "Este enlace no se pudo previsualizar"),
        "post_body_link_preview__error_with_description": m36,
        "post_body_media__unsupported":
            MessageLookupByLibrary.simpleMessage("Tipo de medio no soportado"),
        ...
        "post_uploader__compressing_media":
            MessageLookupByLibrary.simpleMessage("Comprimiendo media..."),
        "post_uploader__creating_post":
            MessageLookupByLibrary.simpleMessage("Creando post..."),
        "post_uploader__generic_upload_failed":
            MessageLookupByLibrary.simpleMessage("Error al subir"),
        "post_uploader__processing":
            MessageLookupByLibrary.simpleMessage("Procesando post..."),
        "post_uploader__publishing":
            MessageLookupByLibrary.simpleMessage("Publicando post..."),
        "post_uploader__success":
            MessageLookupByLibrary.simpleMessage("¡Éxito!"),
        "post_uploader__uploading_media":
            MessageLookupByLibrary.simpleMessage("Subiendo media..."),
        "posts_stream__all_loaded":
            MessageLookupByLibrary.simpleMessage("🎉 Todos los posts cargados"),
        "posts_stream__empty_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Intenta refrescar en un par de segundos."),
        "posts_stream__empty_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Este stream está vacío."),
        ...
        "posts_stream__refreshing_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage("Refrescando el stream."),
        "posts_stream__refreshing_drhoo_title":
            MessageLookupByLibrary.simpleMessage("¡Ya casi!"),
        "posts_stream__status_tile_empty":
            MessageLookupByLibrary.simpleMessage("No se encontraron posts"),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "No puedes usar Kootumb hasta que aceptes las reglas."),
        ...
        "user__disable_new_post_notifications":
            MessageLookupByLibrary.simpleMessage(
                "Desactivar nuevas notificaciones de publicaciones"),
        ...
        "user__edit_profile_community_posts":
            MessageLookupByLibrary.simpleMessage("Posts de comunidades"),
        ...
        "user__enable_new_post_notifications":
            MessageLookupByLibrary.simpleMessage(
                "Activar notificaciones de nuevas publicaciones"),
        "user__follow_button_follow_back_text":
            MessageLookupByLibrary.simpleMessage("Seguir de vuelta"),
        ...
        "user__profile_action_user_post_notifications_disabled":
            MessageLookupByLibrary.simpleMessage(
                "Notificaciones nuevas publicaciones deshabilitadas"),
        ...
        "user__profile_in_circles":
            MessageLookupByLibrary.simpleMessage("En círculos"),
        "user__profile_location_length_error": m55,
        "user__profile_kootumb_age_toast": m56,
