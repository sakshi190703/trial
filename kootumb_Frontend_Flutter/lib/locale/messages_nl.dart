...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(username) =>
      "Weet je zeker dat je @${username} wil blokkeren?";
  ...
  static String m11(min) =>
      "Je dient tenminste ${min} categorieën te selecteren.";

  static String m12(min) =>
      "Je dient tenminste ${min} categorie te selecteren.";

  static String m13(max) => "Kies ${max} categorieën";

  static String m14(maxLength) =>
      "Regels mogen niet langer zijn dan ${maxLength} tekens.";

  static String m15(takenName) => "Community naam ‘${takenName}’ is bezet";
  ...
  static String m18(hashtag) => "Je bent de eerste die #${hashtag} gebruikt";

  static String m19(platform) => "Draaiend op ${platform}";

  static String m20(currentUserLanguage) => "Taal (${currentUserLanguage})";

  static String m21(limit) => "Bestand te groot (limiet: ${limit} MB)";
  ...
  static String m31(commentsCount) =>
      "Bekijk alle ${commentsCount} commentaren";
  ...
  static String m34(name) => "${name} heeft nog niets gedeeld.";

  static String m35(postCreatorUsername) => "@${postCreatorUsername}'s kringen";
  ...
  static String m38(prettyUsersCount) => "${prettyUsersCount} mensen";

  static String m39(username) =>
      "Weet je zeker dat je @${username} wil blokkeren?";

  static String m40(userName) => "Bevestig connectie met ${userName}";

  static String m41(userName) => "Verbind met ${userName}";

  static String m42(userName) => "Verbinding verbreken met ${userName}";

  static String m43(limit) => "Afbeelding is te groot (limiet: ${limit} MB)";

  static String m44(username) => "De gebruikersnaam @${username} is al bezet";

  static String m45(searchQuery) =>
      "Geen emoji gevonden die overeenkomen met '${searchQuery}'.";

  static String m46(searchQuery) => "Geen lijst gevonden voor '${searchQuery}'";

  static String m47(prettyUsersCount) => "${prettyUsersCount} accounts";

  static String m48(prettyUsersCount) => "${prettyUsersCount} Accounts";

  static String m49(groupName) => "Zie alle ${groupName}";

  static String m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Hey, ik wil u uitnodigen voor Kootumb.\n\nVoor Apple, eerst, download de TestFlight app op iTunes (${testFlightLink}) en download dan de Kootumb app (${iosLink})\n\nvoor Android, download het uit de Play store (${androidLink}).\n\nseconde, plak deze persoonlijke uitnodiging in het formulier 'Aanmelden' in de Kootumb App: ${inviteLink}";

  static String m51(username) => "Doet mee met gebruikersnaam @${username}";
  ...
  static String m56(age) => "Op Kootumb sinds ${age}";
  ...
  static String m58(listName) =>
      "De naam van de lijst ‘${listName}’ is al bezet";

  static String m59(searchQuery) => "Geen resultaat voor '${searchQuery}'.";

  static String m60(resourcePluralName) =>
      "${resourcePluralName} niet gevonden.";

  static String m61(resourcePluralName) => "Zoek ${resourcePluralName} ...";

  static String m62(searchQuery) =>
      "Geen communities gevonden voor '${searchQuery}'.";

  static String m63(searchQuery) =>
      "Geen hashtags gevonden voor '${searchQuery}'.";
  ...
  static String m66(searchQuery) => "Zoeken naar '${searchQuery}'";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Gebruik de link van de Join Kootumb knop in uw uitnodigingsmail."),
        ...
        "drawer__main_title":
            MessageLookupByLibrary.simpleMessage("Mijn Kootumb"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Kootumb richtlijnen"),
        ...
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "Een plek om alles te bespreken over Kootumb"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Kootumb ondersteunen"),
        ...
        "moderation__moderated_object_verified_by_staff":
            MessageLookupByLibrary.simpleMessage(
                "Geverifieerd door Kootumb staf"),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "Je kunt Kootumb niet gebruiken totdat je de richtlijnen accepteert."),
