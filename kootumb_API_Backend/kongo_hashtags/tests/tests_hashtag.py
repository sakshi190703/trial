...
from kongo_common.tests.helpers import make_user, make_authentication_headers_for_user, make_hashtag, \
...
class HashtagAPITests(kongoAPITestCase):
    """
    HashtagAPITests
    """
...
class HashtagPostsAPITests(kongoAPITestCase):
    """
