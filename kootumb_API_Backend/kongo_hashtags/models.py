...
from kongo_common.utils.helpers import delete_file_field, get_random_pastel_color
from kongo_common.validators import hex_color_validator
from kongo_communities.models import Community
from kongo_hashtags.helpers import upload_to_hashtags_directory
from kongo_hashtags.validators import hashtag_name_validator
from kongo_posts.models import Post, PostComment
from kongo_posts.queries import make_only_public_posts_query
...
class Hashtag(models.Model):
    ...
    moderated_object = GenericRelation('kongo_moderation.ModeratedObject', related_query_name='hashtags')
