...
from kongo.settings import COLOR_ATTR_MAX_LENGTH
from kongo_categories.models import Category
from kongo_categories.validators import category_name_exists
from kongo_common.serializers import CommonCommunityMembershipSerializer
from kongo_common.serializers_fields.community import CommunityPostsCountField
...
from kongo_communities.serializers_fields import IsInvitedField, IsCreatorField, CommunityMembershipsField, \
    IsFavoriteField, AreNewPostNotificationsEnabledForCommunityField
from kongo_communities.validators import community_name_characters_validator, community_name_not_taken_validator
