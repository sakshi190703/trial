...
from kongo_common.tests.helpers import make_user, make_authentication_headers_for_user, \
...
from kongo_common.utils.model_loaders import get_community_model
...
class CommunitiesAPITests(kongoAPITestCase):
    """
    CommunitiesAPI
    """
...
class JoinedCommunities(kongoAPITestCase):
...
class SearchJoinedCommunitiesAPITests(kongoAPITestCase):
    """
...
class AdministratedCommunities(kongoAPITestCase):
...
class SearchAdministratedCommunitiesAPITests(kongoAPITestCase):
    """
...
class ModeratedCommunities(kongoAPITestCase):
...
class SearchModeratedCommunitiesAPITests(kongoAPITestCase):
    """
...
class FavoriteCommunities(kongoAPITestCase):
...
class SearchFavoriteCommunitiesAPITests(kongoAPITestCase):
    """
...
class CommunityNameCheckAPITests(kongoAPITestCase):
    """
...
class SearchCommunitiesAPITests(kongoAPITestCase):
    """
...
class TrendingCommunitiesAPITests(kongoAPITestCase):
    """
...
class SuggestedCommunitiesAPITests(kongoAPITestCase):
    """
