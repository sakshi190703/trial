...
from kongo_common.tests.helpers import make_user, make_authentication_headers_for_user, \
    make_community
from kongo_communities.models import Community, CommunityNotificationsSubscription
from kongo_notifications.models import CommunityInviteNotification, Notification

logger = logging.getLogger(__name__)
fake = Faker()


class CommunityMembersAPITest(kongoAPITestCase):
...
class InviteCommunityMembersAPITest(kongoAPITestCase):
...
class UninviteCommunityMembersAPITest(kongoAPITestCase):
...
class JoinCommunityAPITest(kongoAPITestCase):
...
class SearchCommunityMembersAPITests(kongoAPITestCase):
    """
...
class LeaveCommunityAPITests(kongoAPITestCase):
