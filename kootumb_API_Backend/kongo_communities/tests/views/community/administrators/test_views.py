...
class CommunityAdministratorsAPITest(kongoAPITestCase):
...
class CommunityAdministratorAPITest(kongoAPITestCase):
...
class SearchCommunityAdministratorsAPITests(kongoAPITestCase):
    """
