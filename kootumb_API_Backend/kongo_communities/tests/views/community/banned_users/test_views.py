...
class Communitybanned_usersAPITest(kongoAPITestCase):
...
class BanCommunityUserAPITest(kongoAPITestCase):
...
class UnbanCommunityUserAPITest(kongoAPITestCase):
...
class SearchCommunityBannedUsersAPITests(kongoAPITestCase):
    """
