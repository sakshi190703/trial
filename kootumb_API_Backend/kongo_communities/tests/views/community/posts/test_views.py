...
from kongo_notifications.models import CommunityNewPostNotification
from kongo_posts.models import Post, PostUserMention
...
class CommunityPostsAPITest(kongoAPITestCase):
...
class CommunityClosedPostsAPITest(kongoAPITestCase):
...
class GetCommunityPostsCountAPITests(kongoAPITestCase):
