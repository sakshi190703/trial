...
class CommunityModeratorsAPITest(kongoAPITestCase):
...
class CommunityModeratorAPITest(kongoAPITestCase):
...
class SearchCommunityModeratorsAPITests(kongoAPITestCase):
    """
