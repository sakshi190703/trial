...
class CommunityAPITests(kongoAPITestCase):
    """
    CommunityAPITests
    """
...
class CommunityAvatarAPITests(kongoAPITestCase):
    """
...
class CommunityCoverAPITests(kongoAPITestCase):
    """
...
class FavoriteCommunityAPITests(kongoAPITestCase):
    """
...
class ExcludeTopPostsCommunityAPITests(kongoAPITestCase):
    """
...
class SubscribeToCommunityNotificationsAPITests(kongoAPITestCase):
