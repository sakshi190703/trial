...
from kongo_auth.models import User, bootstrap_user_circles, bootstrap_user_notifications_settings, \
...
class Command(BaseCommand):
    ...
    def _fix_missing_profile(self):
        ...
        for user in users:
            ...
            bootstrap_user_profile(user=user, is_of_legal_age=True, avatar=None, name='kongo')
