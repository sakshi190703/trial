...
from kongo_common.tests.helpers import make_user, make_badge, make_authentication_headers_for_user
from kongo_invitations.models import UserInvite
...
class RegistrationAPITests(kongoAPITestCase):
    """
    RegistrationAPI
    """
    ...
    def test_token_can_be_used_once(self):
        ...
        first_request_data = {'name': 'Joel Hernandez', 'email': 'joel@kon-go.org',
        ...
        second_request_data = {'name': 'Juan Taramera', 'email': 'joel2@kon-go.org',
...
class VerifyRegistrationTokenAPITests(kongoAPITestCase):
    """
...
class RequestPasswordResetAPITests(kongoAPITestCase):
    ...
    def test_request_password_reset_successfully_with_valid_email(self):
        ...
        self.assertEqual(email_message.subject, 'Reset your password for kootumb')

    def _get_url(self):
        return reverse('request-password-reset')


class VerifyResetPasswordAPITests(kongoAPITestCase):
...
class UsernameCheckAPITests(kongoAPITestCase):
    """
    UsernameCheckAPI
    """
...
class EmailCheckAPITests(kongoAPITestCase):
    """
    EmailCheckAPI
    """
    ...
    def test_valid_email(self):
        ...
        """
        url = self._get_url()
        emails = ('joel@kon-go.org', 'gerald@rivia.com', 'obi@wan.com', 'c3po@robot.me')
        for email in emails:
            data = {
                'email': email
            }
...
class LoginAPITests(kongoAPITestCase):
    """
    LoginAPI
    """
...
class VerifyChangeEmailAPITests(kongoAPITestCase):
