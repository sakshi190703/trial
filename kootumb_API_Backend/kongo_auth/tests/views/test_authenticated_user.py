...
from kongo_auth.views.authenticated_user.views import AuthenticatedUserSettings
from kongo_common.tests.helpers import make_user, make_authentication_headers_for_user, make_user_bio, \
...
class AuthenticatedUserAPITests(kongoAPITestCase):
    """
...
class AuthenticatedUserDeleteTests(kongoAPITestCase):
    fixtures = [
        'kongo_circles/fixtures/circles.json'
    ]
...
class AuthenticatedUserNotificationsSettingsTests(kongoAPITestCase):
    """
...
class AuthenticatedUserSettingsAPITests(kongoAPITestCase):
    """
    User Settings API
    """
...
class AuthenticatedUserAcceptGuidelines(kongoAPITestCase):
    """
...
class AuthenticatedUserLanguageAPI(kongoAPITestCase):
    """
