...
import logging
import json
from kongo_common.tests.helpers import make_user, make_authentication_headers_for_user, make_fake_post_text
from kongo_common.utils.model_loaders import get_user_notifications_subscription_model
...
class SearchUsersAPITests(kongoAPITestCase):
    """
    UsersAPI
    """
...
class GetUserAPITests(kongoAPITestCase):
    """
    UserAPI
    """
...
class BlockUserAPITests(kongoAPITestCase):
    """
    BlockUserAPI
    """
    fixtures = [
...
class UnblockUserAPITests(kongoAPITestCase):
    """
    UnblockUserAPI
    """
...
class SubscribeToUserNotificationsAPITests(kongoAPITestCase):
    """
...
class GetUserPostsCountAPITests(kongoAPITestCase):
