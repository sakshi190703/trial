...
def create_notifications_settings(apps, schema_editor):
    User = apps.get_model('kongo_auth', 'User')
    UserNotificationsSettings = apps.get_model('kongo_auth', 'UserNotificationsSettings')
...
class Migration(migrations.Migration):
    dependencies = [
        ('kongo_auth', '0023_usernotificationssettings'),
    ]
