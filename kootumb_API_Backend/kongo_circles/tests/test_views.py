...
from kongo_common.tests.helpers import make_user, make_authentication_headers_for_user, make_fake_circle_name
...
class CirclesAPITests(kongoAPITestCase):
    """
    CirclesAPI
    """
...
class CircleItemAPITests(kongoAPITestCase):
    """
    CircleItemAPI
    """
    fixtures = [
...
class CircleNameCheckAPITests(kongoAPITestCase):
    """
    CircleNameCheckAPI
    """
