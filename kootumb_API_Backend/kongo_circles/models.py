...
from kongo.settings import CIRCLE_MAX_LENGTH, COLOR_ATTR_MAX_LENGTH
from kongo_auth.models import User
from kongo_common.utils.model_loaders import get_connection_model
from kongo_connections.models import Connection
...
class ConnectionCircle(models.Model):
    ...
    circle = models.ForeignKey('kongo_circles.Circle', on_delete=models.CASCADE)
...
class Circle(models.Model):
    creator = models.ForeignKey('kongo_auth.User', on_delete=models.CASCADE, related_name='circles', null=True)
