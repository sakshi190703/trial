...
from kongo_posts.validators import post_text_validators, post_comment_text_validators
from video_encoding.backends import get_backend
from video_encoding.fields import VideoField
from video_encoding.models import Format

from kongo.storage_backends import S3PrivateMediaStorage
from kongo_auth.models import User

from kongo_common.models import Emoji, Language
from kongo_common.utils.helpers import delete_file_field, sha256sum, extract_usernames_from_string, get_magic, \
    write_in_memory_file_to_disk, extract_hashtags_from_string, normalize_url
from kongo_common.utils.model_loaders import get_emoji_model, \
...
from kongo_notifications.helpers import send_post_comment_user_mention_push_notification, \
    send_post_user_mention_push_notification, send_community_new_post_push_notification, \
    send_user_new_post_push_notification
from kongo_posts.checkers import check_can_be_updated, check_can_add_media, check_can_be_published, \
    check_mimetype_is_supported_media_mimetypes
from kongo_posts.helpers import upload_to_post_image_directory, upload_to_post_video_directory, \
    upload_to_post_directory
from kongo_posts.jobs import process_post_media

magic = get_magic()
from kongo_common.helpers import get_language_for_text, extract_urls_from_string
...
class Post(models.Model):
    ...
    community = models.ForeignKey('kongo_communities.Community', on_delete=models.CASCADE, related_name='posts',
                                  null=True,
                                  blank=False)
    ...
    class Meta:
        indexes = [
            models.Index(fields=['creator', 'community']),
        ]
...
class TopPostCommunityExclusion(models.Model):
    ...
    community = models.ForeignKey('kongo_communities.Community', on_delete=models.CASCADE,
