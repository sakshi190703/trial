...
from kongo_posts.views.post.serializers import DeletePostSerializer, GetPostSerializer, GetPostPostSerializer, \
...
from kongo_translation.strategies.base import TranslationClientError, UnsupportedLanguagePairException, \
