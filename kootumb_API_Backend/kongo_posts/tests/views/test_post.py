...
from kongo_common.tests.helpers import make_authentication_headers_for_user, make_fake_post_text, \
...
from kongo_common.utils.model_loaders import get_language_model, get_community_new_post_notification_model, \
...
from kongo_notifications.models import PostUserMentionNotification, Notification
from kongo_posts.models import Post, PostUserMention, PostMedia
from kongo_common.models import ProxyBlacklistedDomain
...
class PostItemAPITests(kongoAPITestCase):
    """
    PostItemAPI
    """
    ...
    @mock.patch('kongo_posts.models.get_language_for_text')
...
class MutePostAPITests(kongoAPITestCase):
    """
    MutePostAPI
    """
...
class UnmutePostAPITests(kongoAPITestCase):
    """
    UnmutePostAPI
    """
...
class PostCloseAPITests(kongoAPITestCase):
    """
...
class PostOpenAPITests(kongoAPITestCase):
    """
...
class TranslatePostAPITests(kongoAPITestCase):
    """
    TranslatePostAPI
    """
...
class SearchPostParticipantsAPITests(kongoAPITestCase):
    """
...
class GetPostParticipantsAPITests(kongoAPITestCase):
    """
    SearchPostParticipantsAPI
    """
...
class PublishPostAPITests(kongoAPITestCase):
    """
    PublishPostAPI
    """
...
class PostStatusAPITests(kongoAPITestCase):
    """
    PostStatusAPI
    """
