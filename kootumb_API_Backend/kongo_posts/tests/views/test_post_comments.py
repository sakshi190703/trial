...
from kongo_notifications.models import PostCommentNotification, PostCommentReplyNotification, \
    PostCommentUserMentionNotification, Notification
from kongo_posts.models import PostComment, PostCommentUserMention, Post

logger = logging.getLogger(__name__)
fake = Faker()


class PostCommentsAPITests(kongoAPITestCase):
    """
    PostCommentsAPI
    """
    ...
    @mock.patch('kongo_notifications.helpers.send_post_comment_push_notification_with_message')
...
class PostCommentsEnableAPITests(kongoAPITestCase):
    """
...
class PostCommentsDisableAPITests(kongoAPITestCase):
    """
