...
from kongo_common.tests.models import kongoAPITestCase
from mixer.backend.django import mixer

from kongo.settings import POST_MAX_LENGTH
from kongo_auth.models import User, UserNotificationsSubscription
import random
...
from kongo_common.tests.helpers import make_user, make_users, make_fake_post_text, \
...
from kongo_common.utils.helpers import sha256sum, normalize_url
...
from kongo_moderation.models import ModeratedObject
from kongo_notifications.models import PostUserMentionNotification, Notification, UserNewPostNotification
from kongo_posts.jobs import curate_top_posts, curate_trending_posts
from kongo_posts.models import Post, PostUserMention, PostMedia, TopPost, TrendingPost, PostLink
...
class PostsAPITests(kongoAPITestCase):
    """
    PostsAPI
    """

    fixtures = [
        'kongo_circles/fixtures/circles.json',
        'kongo_common/fixtures/languages.json'
    ]
    ...
    def test_create_text_post_with_only_link_should_not_throw_error(self):
        ...
        post_text = 'https://www.kootumb.io'
    ...
    def test_can_get_public_posts_for_kootumb_visibility_user_authenticated(self):
        """
        should be able to retrieve the public posts of an specific kootumb visibility user
        ...
        user_to_retrieve_posts_from = make_user(visibility=User.VISIBILITY_TYPE_kootumb)
    ...
    def test_cant_get_public_posts_for_kootumb_visibility_user_unauthenticated(self):
        """
        should not be able to retrieve the public posts of an specific kootumb visibility user
        being unauthenticated and return 400
        """
        user = make_user(visibility=User.VISIBILITY_TYPE_kootumb)
    ...
    def test_can_retrieve_posts_with_recent_unconfirmed_connection_encircled_post(self):
        ...
        https://github.com/kongoOrg/kongo-api/issues/301
        """
        user = make_user()
    ...
    @mock.patch('kongo_posts.jobs.process_post_media')
...
class TrendingPostsAPITests(kongoAPITestCase):
    """
...
class TopPostsAPITests(kongoAPITestCase):
    """
    TopPostsAPITests
    """
...
class ProfilePostsExcludedCommunitiesAPITests(kongoAPITestCase):
    """
...
class SearchProfilePostsExcludedCommunitiesAPITests(kongoAPITestCase):
    """
...
class ProfilePostsExcludedCommunityAPITests(kongoAPITestCase):
    """
...
class TopPostsExcludedCommunitiesAPITests(kongoAPITestCase):
    """
...
class SearchTopPostsExcludedCommunitiesAPITests(kongoAPITestCase):
    """
...
class TopPostsExcludedCommunityAPITests(kongoAPITestCase):
    """
