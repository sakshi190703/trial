...
from kongo_common.tests.helpers import make_authentication_headers_for_user, make_fake_post_text, \
    ...
    make_community
from kongo_notifications.models import PostCommentReactionNotification
from kongo_posts.models import PostCommentReaction
...
class PostCommentReactionsAPITests(kongoAPITestCase):
    """
    ...
    @mock.patch('kongo_notifications.helpers.send_post_comment_reaction_push_notification')
...
class PostCommentReactionsEmojiCountAPITests(kongoAPITestCase):
    """
