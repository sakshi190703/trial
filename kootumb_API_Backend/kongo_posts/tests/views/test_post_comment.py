...
from kongo_common.utils.model_loaders import get_language_model
from kongo_communities.models import Community
from kongo_hashtags.models import Hashtag
from kongo_notifications.models import PostCommentNotification, Notification, PostCommentReplyNotification, \
    PostCommentUserMentionNotification
from kongo_posts.models import PostComment, PostCommentUserMention

logger = logging.getLogger(__name__)
fake = Faker()


class PostCommentItemAPITests(kongoAPITestCase):
    """
    PostCommentItemAPI
    """
...
class MutePostCommentAPITests(kongoAPITestCase):
    """
    MutePostCommentAPI
    """
...
class UnmutePostCommentAPITests(kongoAPITestCase):
    """
...
class TranslatePostCommentAPITests(kongoAPITestCase):
    """
