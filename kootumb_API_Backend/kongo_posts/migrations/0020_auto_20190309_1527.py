...
def create_post_image_width_and_height(apps, schema_editor):
    PostImage = apps.get_model('kongo_posts', 'PostImage')
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=imagekit.models.fields.ProcessedImageField(null=True,
                                                             upload_to=kongo_posts.helpers.upload_to_post_image_directory,
                                                             verbose_name='image'),
        ),
        migrations.AlterField(
            model_name='postvideo',
            name='video',
            field=models.FileField(upload_to=kongo_posts.helpers.upload_to_post_video_directory,
                                   verbose_name='video'),
        ),
    ]
