...
from kongo_common.tests.helpers import make_user, make_authentication_headers_for_user, make_device
from kongo_devices.models import Device

fake = Faker()


class DevicesAPITests(kongoAPITestCase):
    """
    DevicesAPI
    """
...
class DeviceItemAPITests(kongoAPITestCase):
    """
    DeviceItemAPI
    """
