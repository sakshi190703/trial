...
from kongo_common.models import Emoji, EmojiGroup, Badge, Language
from kongo_common.utils.helpers import get_random_pastel_color
from kongo_communities.models import Community
from kongo_devices.models import Device
from kongo_hashtags.models import Hashtag
from kongo_lists.models import List
from kongo_moderation.models import ModerationCategory, ModeratedObjectLog, ModeratedObject, ModerationReport, \
    ModerationPenalty
from kongo_notifications.models import Notification
...
def make_user(username=None, invite_count=None, name=None, visibility=User.VISIBILITY_TYPE_kootumb):
...
def get_test_videos():
    return [
        {
            'path': 'kongo_common/tests/files/test_video.mp4',
            'duration': 5.312,
            'width': 1280,
            'height': 720
        },
        {
            'path': 'kongo_common/tests/files/test_video.3gp',
            'duration': 40.667,
            'width': 176,
            'height': 144
        },
        {
            'path': 'kongo_common/tests/files/test_gif_medium.gif',
            'duration': 1.5,
            'width': 312,
            'height': 312
        },
        {
            'path': 'kongo_common/tests/files/test_gif_tiny.gif',
            'duration': 0.771,
            'width': 256,
            'height': 256
        }
...
def get_test_images():
    return [
        {
            'path': 'kongo_common/tests/files/test_image_tiny.png',
            'width': 272,
            'height': 170
        },
        {
            'path': 'kongo_common/tests/files/test_image_small.png',
            'width': 912,
            'height': 513
        },
        {
            'path': 'kongo_common/tests/files/test_image_medium.png',
            'width': 5891,
            'height': 2271
        },
        {
            'path': 'kongo_common/tests/files/test_image_tiny.jpg',
            'width': 300,
            'height': 300
        },
        {
            'path': 'kongo_common/tests/files/test_image_small.jpg',
            'width': 2192,
            'height': 2921
        },
        {
            'path': 'kongo_common/tests/files/test_image_medium.jpg',
            'width': 10751,
            'height': 4287
        },
    ]
