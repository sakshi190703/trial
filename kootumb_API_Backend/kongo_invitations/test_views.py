...
class UserInvitesAPITests(kongoAPITestCase):
    """
    UserInvitesAPI
    """
...
class UserInviteSearchAPITests(kongoAPITestCase):
...
class UserInviteItemAPITests(kongoAPITestCase):
    """
    UserInvitesItemAPI
    """
...
class UserInviteItemEmailAPI(kongoAPITestCase):
    """
