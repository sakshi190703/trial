...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('kongo_follows', '0002_auto_20181023_1255'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='follow',
            name='list',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='follows', to='kongo_lists.List'),
        ),
    ]
