...
from kongo_follows.models import Follow, FollowRequest
from kongo_notifications.models import FollowNotification, Notification, FollowRequestNotification, \
...
class ReceivedFollowRequestsAPITests(kongoAPITestCase):
...
class RequestToFollowUserAPITests(kongoAPITestCase):
    ...
    @mock.patch('kongo_notifications.helpers.send_follow_request_push_notification')
    ...
    @mock.patch('kongo_notifications.helpers._send_notification_to_user')
...
class CancelRequestToFollowUserAPITests(kongoAPITestCase):
...
class ApproveUserFollowRequestAPITests(kongoAPITestCase):
    ...
    @mock.patch('kongo_notifications.helpers.send_follow_request_approved_push_notification')
    ...
    @mock.patch('kongo_notifications.helpers.send_follow_push_notification')
...
class RejectUserFollowRequestAPITests(kongoAPITestCase):
...
class FollowAPITests(kongoAPITestCase):
...
class UnfollowAPITest(kongoAPITestCase):
...
class UpdateFollowAPITest(kongoAPITestCase):
