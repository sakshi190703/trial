...
from kongo_common.utils.model_loaders import get_post_model, get_post_comment_model, get_community_model, \
...
class ModeratedObject(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(name='moderated_object_unique_constraint',
...
class ModerationReport(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(name='moderation_report_unique_constraint',
