...
from kongo_common.tests.helpers import make_user, make_moderation_category, \
    make_authentication_headers_for_user, make_moderation_penalty, make_community, make_fake_post_text

fake = Faker()


class UserModerationPenaltiesAPITests(kongoAPITestCase):
    """
...
class UserPendingModeratedObjectsCommunitiesAPITests(kongoAPITestCase):
    """
