...
from kongo_common.tests.helpers import make_user, make_authentication_headers_for_user, make_notification, \
...
from kongo_moderation.models import ModerationReport, ModeratedObject

fake = Faker()


class ReportPostAPITests(kongoAPITestCase):
    """
    ReportPostAPI
    """
...
class ReportPostCommentAPITests(kongoAPITestCase):
    """
...
class ReportUserAPITests(kongoAPITestCase):
    """
    ReportUserAPI
    """
...
class ReportCommunityAPITests(kongoAPITestCase):
    """
    ReportCommunityAPI
    """
...
class ReportHashtagAPITests(kongoAPITestCase):
    """
    ReportHashtagAPI
    """
