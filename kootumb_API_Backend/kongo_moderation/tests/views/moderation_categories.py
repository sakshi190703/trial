...
from kongo_common.tests.helpers import make_user, make_authentication_headers_for_user, make_moderation_category

fake = Faker()


class ModerationCategoriesAPITests(kongoAPITestCase):
    """
