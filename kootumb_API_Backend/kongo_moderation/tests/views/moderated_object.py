...
from kongo_common.tests.helpers import make_global_moderator, make_user, make_moderation_category, \
...
from kongo_common.utils.model_loaders import get_user_new_post_notification_model, \
...
from kongo_moderation.models import ModeratedObject, ModeratedObjectDescriptionChangedLog, \
...
from kongo_posts.models import Post, PostComment

fake = Faker()


class ModeratedObjectAPITests(kongoAPITestCase):
    """
    ModeratedObjectAPI
    """
...
class ApproveModeratedObjectApiTests(kongoAPITestCase):
    """
    ModeratedObjectAPI
    """
...
class RejectModeratedObjectApiTests(kongoAPITestCase):
    """
    ModeratedObjectAPI
    """
...
class VerifyModeratedObjectApiTests(kongoAPITestCase):
    """
...
class UnverifyModeratedObjectApiTests(kongoAPITestCase):
    """
...
class ModeratedObjectLogs(kongoAPITestCase):
...
class ModeratedObjectReports(kongoAPITestCase):
