...
from kongo_common.tests.helpers import make_user
from kongo_common.tests.helpers import make_authentication_headers_for_user


# DISABLED
class UploadFileTests(kongoAPITestCase):
    ...
    def upload_file_success(self):
        ...
        with open('kongo_importer/tests/facebook-jaybeenote5.zip',
                  'rb') as fd:
    ...
    def upload_file_malicious(self):
        ...
        with open('kongo_importer/tests/evil.zip', 'rb') as fd:
            response = self.client.post(reverse('uploads'), {'file': fd},
                                        **headers)
    ...
    def test_upload_file_invalid(self):
        ...
        with open('kongo_importer/tests/invalid.zip', 'rb') as fd:
            response = self.client.post(reverse('uploads'), {'file': fd},
                                        **headers)
