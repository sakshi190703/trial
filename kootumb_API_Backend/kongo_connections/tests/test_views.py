...
from kongo_common.tests.helpers import make_user, make_authentication_headers_for_user, make_circle
from kongo_notifications.models import ConnectionConfirmedNotification, ConnectionRequestNotification, Notification
...
class ConnectionsAPITests(kongoAPITestCase):
    """
    ConnectionsAPI
    """
...
class ConnectAPITests(kongoAPITestCase):
    fixtures = [
        'kongo_circles/fixtures/circles.json'
    ]
    ...
    def test_can_connect_with_kootumb_visibility_without_previously_following(self):
        """
        should be able to connect with a kootumb visibility without having previously followed the person and return 400
        """
        user = make_user()
        headers = make_authentication_headers_for_user(user)
...
class DisconnectAPITest(kongoAPITestCase):
    fixtures = [
        'kongo_circles/fixtures/circles.json'
    ]
...
class UpdateConnectionAPITest(kongoAPITestCase):
    fixtures = [
        'kongo_circles/fixtures/circles.json'
    ]
...
class ConfirmConnectionAPITest(kongoAPITestCase):
    fixtures = [
        'kongo_circles/fixtures/circles.json'
    ]
